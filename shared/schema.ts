...
export const userPermissionsMatrix = pgTable(
...
export const userActivityLogs = pgTable(
  "user_activity_logs",
  {
    ...
    impersonatedUserId: varchar("impersonated_user_id").references(
      () => userManagement.id,
...
export const staffTaskPermissions = pgTable(
...
export const permissionPresets = pgTable(
  "permission_presets",
  {
    id: serial("id").primaryKey(),
    organizationId: varchar("organization_id")
...
export const userPropertyAssignments = pgTable(
...
export const freelancerAvailability = pgTable(
...
export const freelancerTaskRequests = pgTable(
...
export const propertyAccessControl = pgTable(
...
export const propertyAccessTemplates = pgTable(
  "property_access_templates",
  {
    ...
    defaultMaintenanceAccess: boolean("default_maintenance_access").default(
      true,
    ),
    defaultGuestBookingAccess: boolean("default_guest_booking_access").default(
      true,
    ),
    defaultUtilitiesAccess: boolean("default_utilities_access").default(true),
    defaultPropertyInfoAccess: boolean("default_property_info_access").default(
      true,
    ),
    defaultServiceOrderAccess: boolean("default_service_order_access").default(
      true,
    ),
...
export const propertyVisibilityMatrix = pgTable(
  "property_visibility_matrix",
  {
    ...
    lastUpdatedBy: varchar("last_updated_by").references(
      () => userManagement.id,
    ),
...
export const userSessionPermissions = pgTable(
...
export const userActivityAudit = pgTable(
  "user_activity_audit",
  {
    id: serial("id").primaryKey(),
    organizationId: varchar("organization_id")
...
export const userPerformanceMetrics = pgTable(
  "user_performance_metrics",
  {
    ...
    clientSatisfactionScore: decimal("client_satisfaction_score", {
      precision: 3,
      scale: 2,
    }),
...
export const properties = pgTable(
  "properties",
  {
    ...
    source: varchar("source")
      .$type<"LOCAL" | "HOSTAWAY">()
      .notNull()
      .default("LOCAL"), // LOCAL or HOSTAWAY
    ...
    rating: decimal("rating", { precision: 3, scale: 2 }), // Property rating (e.g., 4.85 out of 5.00)

    // 🟦 existing field – keep it for backward compatibility
    hostawayId: varchar("hostaway_id"),

    // 🆕 explicit Hostaway mapping fields
    hostawayListingMapId: integer("hostaway_listing_map_id"), // used for reservations API
    hostawayPropertyId: integer("hostaway_property_id"), // original Hostaway property id
    hostawayAccountId: integer("hostaway_account_id"), // for multi-account setups
...
export const tasks: any = pgTable("tasks", {
  ...
  assignedTo: varchar("assigned_to").references(() => users.id), // Legacy: user assignment
  assignedToStaffId: integer("assigned_to_staff_id").references(
    () => staffMembers.id,
...
export const inventoryUsageLogs = pgTable(
...
// Task Proof Uploads
export const taskProofUploads = pgTable(
  "task_proof_uploads",
  {
    id: serial("id").primaryKey(),
    organizationId: varchar("organization_id")
...
// Monthly Export Logs
export const monthlyExportLogs = pgTable(
  "monthly_export_logs",
  {
    id: serial("id").primaryKey(),
    organizationId: varchar("organization_id")
...
export const bookings = pgTable("bookings", {
  ...
  organizationId: varchar("organization_id")
    ...
    .notNull(),
  externalId: varchar("external_id"), // ID from external system (Hostaway, etc.)
  source: varchar("source").default("LOCAL").notNull(), // LOCAL or HOSTAWAY
  ...
  otaCommissionAmount: decimal("ota_commission_amount", {
    precision: 10,
    scale: 2,
  }), // OTA commission deducted
  otaCommissionPercentage: decimal("ota_commission_percentage", {
    precision: 5,
    scale: 2,
  }), // OTA commission rate
...
export const guestServiceRequests = pgTable(
...
export const guestConfirmedServices = pgTable(
  "guest_confirmed_services",
  {
    ...
    linkedServiceRequestId: integer("linked_service_request_id").references(
      () => guestServiceRequests.id,
    ),
    linkedAddonBookingId: integer("linked_addon_booking_id").references(
      () => addonBookings.id,
    ),
...
export const bookingLinkedTasks = pgTable(
...
export const addonBookings = pgTable("addon_bookings", {
  ...
  bookedBy: varchar("booked_by")
    .references(() => users.id)
    .notNull(), // user who made the booking
...
export const utilityBills = pgTable("utility_bills", {
  ...
  propertyId: integer("property_id")
    .references(() => properties.id)
    .notNull(),
  utilityAccountId: integer("utility_account_id").references(
...
export const utilityBillReminders = pgTable("utility_bill_reminders", {
  id: serial("id").primaryKey(),
  organizationId: varchar("organization_id").notNull(),
  utilityBillId: integer("utility_bill_id").references(() => utilityBills.id, {
    onDelete: "cascade",
  }),
...
// Utility Alert Rules for automated monitoring
export const utilityAlertRules = pgTable("utility_alert_rules", {
  id: serial("id").primaryKey(),
  organizationId: varchar("organization_id").notNull(),
  propertyId: integer("property_id").references(() => properties.id, {
    onDelete: "cascade",
  }), // NULL = applies to all properties
  utilityType: varchar("utility_type"), // NULL = applies to all types
  alertType: varchar("alert_type").notNull(), // upcoming_due_date, overdue_bill, high_amount, missing_receipt
  threshold: decimal("threshold", { precision: 10, scale: 2 }), // For high_amount alerts
  daysBeforeDue: integer("days_before_due"), // For upcoming_due_date alerts
  isEnabled: boolean("is_enabled").default(true),
  notifyUsers: text("notify_users").array(), // Array of user IDs to notify
  notifyRoles: text("notify_roles").array(), // Array of roles to notify (admin, owner, etc.)
  createdBy: varchar("created_by").references(() => users.id),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
});
...
export const otaBookingPayouts = pgTable("ota_booking_payouts", {
  ...
  otaPlatform: varchar("ota_platform").notNull(), // airbnb, booking_com, vrbo, direct
  guestPaidAmount: decimal("guest_paid_amount", {
    precision: 10,
    scale: 2,
  }).notNull(),
  netPayoutAmount: decimal("net_payout_amount", {
    precision: 10,
    scale: 2,
  }).notNull(),
  otaCommissionAmount: decimal("ota_commission_amount", {
  ...
  otaCommissionRate: decimal("ota_commission_rate", {
    precision: 5,
    scale: 2,
  }).notNull(),
...
export const otaPayoutAlerts = pgTable("ota_payout_alerts", {
  id: serial("id").primaryKey(),
  organizationId: varchar("organization_id").notNull(),
  bookingPayoutId: integer("booking_payout_id").references(
...
export const otaRevenueReports = pgTable("ota_revenue_reports", {
  ...
  totalGrossRevenue: decimal("total_gross_revenue", {
    precision: 12,
    scale: 2,
  }).notNull(),
  totalNetPayout: decimal("total_net_payout", {
    precision: 12,
    scale: 2,
  }).notNull(),
  totalOtaCommissions: decimal("total_ota_commissions", {
    precision: 12,
    scale: 2,
  }).notNull(),
  totalBookings: integer("total_bookings").notNull(),
  averageOtaCommissionRate: decimal("average_ota_commission_rate", {
    precision: 5,
    scale: 2,
  }),
...
export const emergencyWaterDeliveries = pgTable("emergency_water_deliveries", {
  ...
  costPerLiter: decimal("cost_per_liter", {
    precision: 10,
    scale: 4,
  }).notNull(), // Auto-calculated THB per liter
...
export const waterUpgradeSuggestions = pgTable("water_upgrade_suggestions", {
  ...
  estimatedCost: decimal("estimated_cost", { precision: 10, scale: 2 }),
  estimatedSavingsPerYear: decimal("estimated_savings_per_year", {
    precision: 10,
    scale: 2,
  }),
...
export const propertyUtilityAccountsRelations = relations(
...
export const utilityBillRemindersRelations = relations(
...
export const welcomePackItemsRelations = relations(
  welcomePackItems,
  ({ many }) => ({
...
export const welcomePackTemplatesRelations = relations(
...
export const welcomePackUsageRelations = relations(
  welcomePackUsage,
  ({ one }) => ({
    property: one(properties, {
...
export const emergencyWaterDeliveriesRelations = relations(
...
export const waterDeliveryAlertsRelations = relations(
  waterDeliveryAlerts,
  ({ one }) => ({
    property: one(properties, {
...
export const waterUpgradeSuggestionsRelations = relations(
...
// Relations
export const waterUtilityRefillsRelations = relations(
  waterUtilityRefills,
  ({ one, many }) => ({
    property: one(properties, {
...
export const waterRefillAlertsRelations = relations(
  waterRefillAlerts,
  ({ one }) => ({
    property: one(properties, {
...
export const waterRefillBillsRelations = relations(
  waterRefillBills,
  ({ one }) => ({
    property: one(properties, {
...
export type EmergencyWaterDelivery =
  typeof emergencyWaterDeliveries.$inferSelect;
export type InsertEmergencyWaterDelivery =
  typeof emergencyWaterDeliveries.$inferInsert;
...
export type WaterUpgradeSuggestion =
  typeof waterUpgradeSuggestions.$inferSelect;
export type InsertWaterUpgradeSuggestion =
  typeof waterUpgradeSuggestions.$inferInsert;
...
export const propertyWaterSources = pgTable("property_water_sources", {
  ...
  // Cost tracking
  averageCostPerLiter: decimal("average_cost_per_liter", {
    precision: 8,
    scale: 4,
  }),
  currency: varchar("currency").notNull().default("THB"),
...
export const propertyWaterSourcesRelations = relations(
...
export const waterConsumptionEntriesRelations = relations(
...
export const waterConsumptionAlertsRelations = relations(
...
export const waterSuppliersRelations = relations(
  waterSuppliers,
  ({ many }) => ({
...
export type InsertPropertyWaterSource =
  typeof propertyWaterSources.$inferInsert;

export type WaterConsumptionEntry = typeof waterConsumptionEntries.$inferSelect;
export type InsertWaterConsumptionEntry =
  typeof waterConsumptionEntries.$inferInsert;

export type WaterConsumptionAlert = typeof waterConsumptionAlerts.$inferSelect;
export type InsertWaterConsumptionAlert =
  typeof waterConsumptionAlerts.$inferInsert;
...
export const guestAiRecommendations = pgTable("guest_ai_recommendations", {
  ...
  propertyId: integer("property_id")
    .references(() => properties.id)
    .notNull(),
  guestBookingId: integer("guest_booking_id").references(
    () => guestBookings.id,
  ),
...
export const guestBookingsRelations = relations(
  guestBookings,
  ({ one, many }) => ({
    property: one(properties, {
...
export const guestAiRecommendationsRelations = relations(
...
export const guestServiceTimelineRelations = relations(
...
export const balanceResetAudit = pgTable("balance_reset_audit", {
  ...
  newBalance: decimal("new_balance", { precision: 10, scale: 2 })
    .notNull()
    .default("0.00"),
...
export const commissionEarningsRelations = relations(
  commissionEarnings,
  ({ one }) => ({
    user: one(users, {
...
export const portfolioAssignmentsRelations = relations(
...
export const ownerBalances = pgTable("owner_balances", {
  ...
  totalPayoutsRequested: decimal("total_payouts_requested", {
    precision: 12,
    scale: 2,
  }).default("0"),
  totalPayoutsPaid: decimal("total_payouts_paid", {
    precision: 12,
    scale: 2,
  }).default("0"),
  thisMonthEarnings: decimal("this_month_earnings", {
    precision: 12,
    scale: 2,
  }).default("0"),
  thisMonthExpenses: decimal("this_month_expenses", {
    precision: 12,
    scale: 2,
  }).default("0"),
  thisMonthNet: decimal("this_month_net", { precision: 12, scale: 2 }).default(
    "0",
  ),
...
export const ownerChargeRequests = pgTable("owner_charge_requests", {
  ...
  ownerId: varchar("owner_id")
    .references(() => users.id)
    .notNull(),
  chargedBy: varchar("charged_by")
    .references(() => users.id)
    .notNull(), // Admin/PM creating charge
  amount: decimal("amount", { precision: 12, scale: 2 }).notNull(),
  currency: varchar("currency", { length: 3 }).default("AUD"),
...
export const propertyUtilityAccountsNew = pgTable(
  "property_utility_accounts_new",
  {
    ...
    averageMonthlyAmount: decimal("average_monthly_amount", {
      precision: 10,
      scale: 2,
    }),
...
export const pmPropertyPerformance = pgTable("pm_property_performance", {
  ...
  occupancyRate: decimal("occupancy_rate", { precision: 5, scale: 2 }).default(
    "0",
  ), // Percentage
...
export const pmCommissionBalanceRelations = relations(
  pmCommissionBalance,
  ({ one }) => ({
    manager: one(users, {
      fields: [pmCommissionBalance.managerId],
      references: [users.id],
    }),
  }),
);

export const pmPayoutRequestsRelations = relations(
  pmPayoutRequests,
  ({ one }) => ({
    manager: one(users, {
...
export const pmTaskLogsRelations = relations(pmTaskLogs, ({ one }) => ({
  manager: one(users, {
    fields: [pmTaskLogs.managerId],
    references: [users.id],
  }),
  task: one(tasks, { fields: [pmTaskLogs.taskId], references: [tasks.id] }),
  property: one(properties, {
    fields: [pmTaskLogs.propertyId],
    references: [properties.id],
  }),
}));

export const pmPropertyPerformanceRelations = relations(
  pmPropertyPerformance,
  ({ one }) => ({
    manager: one(users, {
      fields: [pmPropertyPerformance.managerId],
      references: [users.id],
    }),
    property: one(properties, {
      fields: [pmPropertyPerformance.propertyId],
      references: [properties.id],
    }),
  }),
);

export const pmNotificationsRelations = relations(
  pmNotifications,
  ({ one }) => ({
    manager: one(users, {
      fields: [pmNotifications.managerId],
      references: [users.id],
    }),
  }),
);
...
export const guestAddonBookings = pgTable("guest_addon_bookings", {
  ...
  bookedBy: varchar("booked_by")
    .references(() => users.id)
    .notNull(), // user ID who made the booking
...
export const guestPortalAccess = pgTable("guest_portal_access", {
  ...
  createdBy: varchar("created_by")
    .references(() => users.id)
    .notNull(), // staff who created access
...
export const guestAddonServicesRelations = relations(
  guestAddonServices,
  ({ one, many }) => ({
...
export const guestAddonBookingsRelations = relations(
  guestAddonBookings,
  ({ one }) => ({
    organization: one(organizations, {
...
export const guestPortalAccessRelations = relations(
  guestPortalAccess,
  ({ one }) => ({
    organization: one(organizations, {
...
export const achievementNotificationsRelations = relations(
...
export const insertPropertyUtilityAccountSchema = createInsertSchema(
  propertyUtilityAccounts,
).omit({
  id: true,
  createdAt: true,
...
export const insertUtilityBillReminderSchema = createInsertSchema(
  utilityBillReminders,
).omit({
  id: true,
  createdAt: true,
...
export const insertUtilityAlertRuleSchema = createInsertSchema(
  utilityAlertRules,
).omit({
  id: true,
  createdAt: true,
...
export const insertWelcomePackItemSchema = createInsertSchema(
  welcomePackItems,
).omit({
  id: true,
  createdAt: true,
...
export const insertWelcomePackTemplateSchema = createInsertSchema(
  welcomePackTemplates,
).omit({
  id: true,
  createdAt: true,
...
export const insertWelcomePackUsageSchema = createInsertSchema(
  welcomePackUsage,
).omit({
  id: true,
  createdAt: true,
...
export const insertEmergencyWaterDeliverySchema = createInsertSchema(
  emergencyWaterDeliveries,
).omit({
  id: true,
  createdAt: true,
...
export const insertWaterDeliveryAlertSchema = createInsertSchema(
  waterDeliveryAlerts,
).omit({
  id: true,
  createdAt: true,
...
export const insertWaterUpgradeSuggestionSchema = createInsertSchema(
  waterUpgradeSuggestions,
).omit({
  id: true,
  createdAt: true,
...
export const insertOwnerChargeRequestSchema = createInsertSchema(
  ownerChargeRequests,
).omit({
  id: true,
  chargedAt: true,
...
export const insertRecurringServiceChargeSchema = createInsertSchema(
  recurringServiceCharges,
).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
...
export const insertAchievementNotificationSchema = createInsertSchema(
  achievementNotifications,
).omit({
  id: true,
  createdAt: true,
...
export type AchievementNotification =
  typeof achievementNotifications.$inferSelect;
...
export const departmentBudgets = pgTable("department_budgets", {
  ...
  actualAmount: decimal("actual_amount", { precision: 12, scale: 2 }).default(
    "0",
  ),
...
export const insertStaffDocumentSchema = createInsertSchema(
  staffDocuments,
).omit({
  id: true,
  uploadedAt: true,
...
export const insertDepartmentBudgetSchema = createInsertSchema(
  departmentBudgets,
).omit({
  id: true,
  createdAt: true,
...
export const propertyUtilityAccountsEnhanced = pgTable(
  "property_utility_accounts_enhanced",
  {
    ...
    predictiveRemindersEnabled: boolean("predictive_reminders_enabled").default(
      true,
    ),
...
export const propertyMaintenanceHistory = pgTable(
...
export const maintenanceServiceIntervals = pgTable(
...
export const propertyAlerts = pgTable("property_alerts", {
  ...
  // Related entities
  relatedUtilityAccountId: integer("related_utility_account_id").references(
    () => propertyUtilityAccountsEnhanced.id,
  ),
  relatedBillLogId: integer("related_bill_log_id").references(
    () => utilityBillLogsEnhanced.id,
  ),
  relatedMaintenanceId: integer("related_maintenance_id").references(
...
export const insertOrganizationApiKeySchema = createInsertSchema(
  organizationApiKeys,
).omit({
  id: true,
  createdAt: true,
...
export type InsertOrganizationApiKey = z.infer<
  typeof insertOrganizationApiKeySchema
>;
export type OrganizationApiKey = typeof organizationApiKeys.$inferSelect;

// Permission system schemas
export const insertUserPermissionOverrideSchema = createInsertSchema(
...
export const insertPermissionPresetSchema = createInsertSchema(
  permissionPresets,
).omit({
  id: true,
  createdAt: true,
...
export type InsertUserPermissionOverride = z.infer<
  typeof insertUserPermissionOverrideSchema
>;
export type UserPermissionOverride =
  typeof userPermissionOverrides.$inferSelect;
export type InsertPermissionPreset = z.infer<
  typeof insertPermissionPresetSchema
>;
...
export type InsertPropertyUtilityAccount = z.infer<
  typeof insertPropertyUtilityAccountSchema
>;
export type PropertyUtilityAccount =
  typeof propertyUtilityAccounts.$inferSelect;
export type InsertUtilityBill = z.infer<typeof insertUtilityBillSchema>;
export type UtilityBill = typeof utilityBills.$inferSelect;
export type InsertUtilityBillReminder = z.infer<
  typeof insertUtilityBillReminderSchema
>;
export type UtilityBillReminder = typeof utilityBillReminders.$inferSelect;
export type InsertUtilityAlertRule = z.infer<typeof insertUtilityAlertRuleSchema>;
export type UtilityAlertRule = typeof utilityAlertRules.$inferSelect;
...
export type InsertWelcomePackTemplate = z.infer<
  typeof insertWelcomePackTemplateSchema
>;
export type WelcomePackTemplate = typeof welcomePackTemplates.$inferSelect;
export type InsertWelcomePackUsage = z.infer<
  typeof insertWelcomePackUsageSchema
>;
...
export const bookingRevenue = pgTable("booking_revenue", {
  ...
  guestBookingPrice: decimal("guest_booking_price", {
    precision: 10,
    scale: 2,
  }).notNull(), // Total paid by guest
  otaPlatformFee: decimal("ota_platform_fee", {
    precision: 10,
    scale: 2,
  }).notNull(), // OTA commission
  finalPayoutAmount: decimal("final_payout_amount", {
    precision: 10,
    scale: 2,
  }).notNull(), // Net received from OTA
  currency: varchar("currency").notNull().default("THB"),
  ...
  managementCommissionRate: decimal("management_commission_rate", {
    precision: 5,
    scale: 2,
  }).default("15.00"),
...
export const bookingRevenueCommissions = pgTable(
  "booking_revenue_commissions",
  {
    ...
    organizationId: varchar("organization_id")
      .references(() => organizations.id)
      .notNull(),
    bookingRevenueId: integer("booking_revenue_id")
      .references(() => bookingRevenue.id)
      .notNull(),

    // Commission Breakdown (All calculated from finalPayoutAmount only)
    managementCommissionAmount: decimal("management_commission_amount", {
      precision: 10,
      scale: 2,
    }).notNull(),
    portfolioManagerCommissionAmount: decimal(
      "portfolio_manager_commission_amount",
      { precision: 10, scale: 2 },
    ).default("0.00"),
    referralAgentCommissionAmount: decimal("referral_agent_commission_amount", {
      precision: 10,
      scale: 2,
    }).default("0.00"),
    ownerNetAmount: decimal("owner_net_amount", {
      precision: 10,
      scale: 2,
    }).notNull(),

    // Commission Recipients
    portfolioManagerId: varchar("portfolio_manager_id").references(
      () => users.id,
    ),
...
export const otaPlatformSettings = pgTable("ota_platform_settings", {
  ...
  expectedCommissionRate: decimal("expected_commission_rate", {
    precision: 5,
    scale: 2,
  }).notNull(), // Expected OTA commission %
  minimumPayoutThreshold: decimal("minimum_payout_threshold", {
    precision: 10,
    scale: 2,
  }).default("0.00"),
...
export const bookingRevenueRelations = relations(
  bookingRevenue,
  ({ one, many }) => ({
    organization: one(organizations, {
...
export const bookingRevenueCommissionsRelations = relations(
...
export const otaPlatformSettingsRelations = relations(
  otaPlatformSettings,
  ({ one }) => ({
    organization: one(organizations, {
...
// Insert Schemas
export const insertBookingRevenueSchema = createInsertSchema(
  bookingRevenue,
).omit({
  id: true,
  createdAt: true,
...
export const insertBookingRevenueCommissionsSchema = createInsertSchema(
  bookingRevenueCommissions,
).omit({
  id: true,
  createdAt: true,
...
export const insertOtaPlatformSettingsSchema = createInsertSchema(
  otaPlatformSettings,
).omit({
  id: true,
  createdAt: true,
...
export type InsertBookingRevenueCommissions = z.infer<
  typeof insertBookingRevenueCommissionsSchema
>;
export type BookingRevenueCommissions =
  typeof bookingRevenueCommissions.$inferSelect;
export type InsertOtaPlatformSettings = z.infer<
  typeof insertOtaPlatformSettingsSchema
>;
...
export const offlineTaskCache = pgTable(
  "offline_task_cache",
  {
    id: serial("id").primaryKey(),
    organizationId: varchar("organization_id").notNull(),
...
export const insertOfflineTaskCacheSchema = createInsertSchema(
  offlineTaskCache,
).omit({
  id: true,
  createdAt: true,
...
export type InsertOfflineTaskCache = z.infer<
  typeof insertOfflineTaskCacheSchema
>;
export type OfflineTaskCache = typeof offlineTaskCache.$inferSelect;

// Marketing Packs schemas
export const insertMarketingPackSchema = createInsertSchema(
  marketingPacks,
).omit({
  id: true,
  createdAt: true,
...
export const sharedCostSplits = pgTable(
  "shared_cost_splits",
  {
    id: serial("id").primaryKey(),
...
export const insertSharedCostSplitSchema = createInsertSchema(
  sharedCostSplits,
).omit({
  id: true,
});
...
export const taskAiScanResults = pgTable(
...
export const insertTaskAiScanResultSchema = createInsertSchema(
  taskAiScanResults,
).omit({
  id: true,
  createdAt: true,
...
export type InsertTaskAiScanResult = z.infer<
  typeof insertTaskAiScanResultSchema
>;
...
export const propertyInvestments = pgTable(
...
export const insertPropertyInvestmentSchema = createInsertSchema(
  propertyInvestments,
).omit({
  id: true,
  createdAt: true,
...
export type InsertPropertyInvestment = z.infer<
  typeof insertPropertyInvestmentSchema
>;
...
export const dynamicPricingRecommendations = pgTable(
...
export const insertDynamicPricingRecommendationSchema = createInsertSchema(
...
export type InsertDynamicPricingRecommendation = z.infer<
  typeof insertDynamicPricingRecommendationSchema
>;
export type DynamicPricingRecommendation =
  typeof dynamicPricingRecommendations.$inferSelect;

// ===== PROPERTY CHAT MESSAGES SYSTEM =====

// Property chat messages for multi-language communication
export const propertyChatMessages = pgTable(
...
export const insertPropertyChatMessageSchema = createInsertSchema(
...
export type InsertPropertyChatMessage = z.infer<
  typeof insertPropertyChatMessageSchema
>;
...
export type InsertPropertyDocument = z.infer<
  typeof insertPropertyDocumentSchema
>;
...
export const upsellRecommendations = pgTable(
...
export const insertUpsellRecommendationSchema = createInsertSchema(
...
export type InsertUpsellRecommendation = z.infer<
  typeof insertUpsellRecommendationSchema
>;
export type UpsellRecommendation = typeof upsellRecommendations.$inferSelect;

// Financial & Invoice Toolkit schemas and types

export const insertCommissionEarningSchema = createInsertSchema(
  commissionEarnings,
).omit({
  id: true,
  createdAt: true,
...
export const insertPortfolioAssignmentSchema = createInsertSchema(
  portfolioAssignments,
).omit({
  id: true,
  assignedAt: true,
...
export const insertGuestAddonServiceSchema = createInsertSchema(
  guestAddonServices,
).omit({
  id: true,
  createdAt: true,
...
export const insertGuestAddonBookingSchema = createInsertSchema(
  guestAddonBookings,
).omit({
  id: true,
  createdAt: true,
...
export const propertyCommissionRules = pgTable("property_commission_rules", {
  ...
  minimumStayCommission: decimal("minimum_stay_commission", {
    precision: 5,
    scale: 2,
  }),
  weeklyCommissionBonus: decimal("weekly_commission_bonus", {
    precision: 5,
    scale: 2,
  }),
  monthlyCommissionBonus: decimal("monthly_commission_bonus", {
    precision: 5,
    scale: 2,
  }),
  ...
  minimumBookingValue: decimal("minimum_booking_value", {
    precision: 10,
    scale: 2,
  }),
  maximumCommissionCap: decimal("maximum_commission_cap", {
    precision: 10,
    scale: 2,
  }),
...
export const propertyGoalsComments = pgTable("property_goals_comments", {
  ...
  propertyId: integer("property_id")
    .references(() => properties.id)
    .notNull(),
  relatedNoteId: integer("related_note_id").references(
...
export const propertyMarketingMediaRelations = relations(
  propertyMarketingMedia,
  ({ one }) => ({
    property: one(properties, {
...
export const propertyCommissionRulesRelations = relations(
  propertyCommissionRules,
  ({ one }) => ({
    property: one(properties, {
...
export const agentBookingRequestsRelations = relations(
...
export const invoiceBookingLinks = pgTable("invoice_booking_links", {
  ...
  bookingRevenue: decimal("booking_revenue", {
    precision: 12,
    scale: 2,
  }).notNull(),
  managementCommission: decimal("management_commission", {
    precision: 12,
    scale: 2,
  }).default(0),
  portfolioManagerCommission: decimal("portfolio_manager_commission", {
    precision: 12,
    scale: 2,
  }).default(0),
  ...
  addonServicesTotal: decimal("addon_services_total", {
    precision: 12,
    scale: 2,
  }).default(0),
...
export const generatedInvoicesRelations = relations(
  generatedInvoices,
  ({ one, many }) => ({
...
export const invoiceBookingLinksRelations = relations(
  invoiceBookingLinks,
  ({ one }) => ({
    invoice: one(generatedInvoices, {
...
export const invoiceServiceLinksRelations = relations(
  invoiceServiceLinks,
  ({ one }) => ({
    invoice: one(generatedInvoices, {
...
export const insertGeneratedInvoiceSchema = createInsertSchema(
  generatedInvoices,
).omit({
  id: true,
  createdAt: true,
...
export const insertInvoiceBookingLinkSchema = createInsertSchema(
  invoiceBookingLinks,
).omit({
  id: true,
  createdAt: true,
...
export const insertInvoiceServiceLinkSchema = createInsertSchema(
  invoiceServiceLinks,
).omit({
  id: true,
  createdAt: true,
...
export type InsertGeneratedInvoice = z.infer<
  typeof insertGeneratedInvoiceSchema
>;
...
export type InsertInvoiceBookingLink = z.infer<
  typeof insertInvoiceBookingLinkSchema
>;

export type InvoiceServiceLink = typeof invoiceServiceLinks.$inferSelect;
export type InsertInvoiceServiceLink = z.infer<
  typeof insertInvoiceServiceLinkSchema
>;

// ===== EXTENDED UTILITIES MANAGEMENT SYSTEM =====

// Property utility master setup - Admin management of who pays for what utilities
export const propertyUtilitiesMaster = pgTable(
...
export const utilityBillsExtended = pgTable(
  "utility_bills_extended",
  {
    ...
    organizationId: varchar("organization_id")
      .references(() => organizations.id)
      .notNull(),
    utilityMasterId: integer("utility_master_id")
      .references(() => propertyUtilitiesMaster.id)
      .notNull(),
    propertyId: integer("property_id")
      .references(() => properties.id)
      .notNull(),
...
export const utilityAccessPermissions = pgTable(
  "utility_access_permissions",
  {
    ...
    setBy: varchar("set_by")
      .references(() => users.id)
      .notNull(), // Admin who set permissions
    createdAt: timestamp("created_at").defaultNow(),
    updatedAt: timestamp("updated_at").defaultNow(),
  },
  (table) => [
...
export const utilityAiPredictions = pgTable(
...
export const utilityNotifications = pgTable(
  "utility_notifications",
  {
    ...
    readAt: timestamp("read_at"),
    sentAt: timestamp("sent_at"),
    relatedBillId: integer("related_bill_id").references(
...
export const ownerStatementExports = pgTable("owner_statement_exports", {
  ...
  totalExpenses: decimal("total_expenses", { precision: 15, scale: 2 }).default(
    0,
  ),
  managementCommission: decimal("management_commission", {
    precision: 15,
...
export const ownerStatementExportsRelations = relations(
...
export const insertOwnerStatementExportSchema = createInsertSchema(
  ownerStatementExports,
).omit({
  id: true,
  createdAt: true,
...
export type InsertOwnerStatementExport = z.infer<
  typeof insertOwnerStatementExportSchema
>;

// ===== PROPERTY UTILITIES & MAINTENANCE SCHEMAS =====

// Insert schemas for utility and maintenance tables
export const insertPropertyUtilityAccountEnhancedSchema = createInsertSchema(
...
export const insertUtilityBillLogEnhancedSchema = createInsertSchema(
...
export const insertUtilityAiReminderSchema = createInsertSchema(
  utilityAiReminders,
).omit({
  id: true,
  createdAt: true,
...
export const insertPropertyMaintenanceHistorySchema = createInsertSchema(
...
export const insertMaintenanceServiceIntervalSchema = createInsertSchema(
...
export const insertMaintenanceAiSuggestionSchema = createInsertSchema(
...
export const insertGuestServiceRequestSchema = createInsertSchema(
...
export const insertGuestConfirmedServiceSchema = createInsertSchema(
...
export const insertBookingLinkedTaskSchema = createInsertSchema(
  bookingLinkedTasks,
).omit({
  id: true,
  createdAt: true,
...
export type InsertGuestServiceRequest = z.infer<
  typeof insertGuestServiceRequestSchema
>;

export type GuestConfirmedService = typeof guestConfirmedServices.$inferSelect;
export type InsertGuestConfirmedService = z.infer<
  typeof insertGuestConfirmedServiceSchema
>;

export type BookingLinkedTask = typeof bookingLinkedTasks.$inferSelect;
export type InsertBookingLinkedTask = z.infer<
  typeof insertBookingLinkedTaskSchema
>;

export const insertPropertyAlertSchema = createInsertSchema(
  propertyAlerts,
).omit({
  id: true,
  createdAt: true,
...
export type PropertyUtilityAccountEnhanced =
  typeof propertyUtilityAccountsEnhanced.$inferSelect;
export type InsertPropertyUtilityAccountEnhanced = z.infer<
  typeof insertPropertyUtilityAccountEnhancedSchema
>;

export type UtilityBillLogEnhanced =
  typeof utilityBillLogsEnhanced.$inferSelect;
export type InsertUtilityBillLogEnhanced = z.infer<
  typeof insertUtilityBillLogEnhancedSchema
>;

export type UtilityAiReminder = typeof utilityAiReminders.$inferSelect;
export type InsertUtilityAiReminder = z.infer<
  typeof insertUtilityAiReminderSchema
>;

export type PropertyMaintenanceHistory =
  typeof propertyMaintenanceHistory.$inferSelect;
export type InsertPropertyMaintenanceHistory = z.infer<
  typeof insertPropertyMaintenanceHistorySchema
>;

export type MaintenanceServiceInterval =
  typeof maintenanceServiceIntervals.$inferSelect;
export type InsertMaintenanceServiceInterval = z.infer<
  typeof insertMaintenanceServiceIntervalSchema
>;

export type MaintenanceAiSuggestion =
  typeof maintenanceAiSuggestions.$inferSelect;
export type InsertMaintenanceAiSuggestion = z.infer<
  typeof insertMaintenanceAiSuggestionSchema
>;
...
export const ownerOnboardingChecklists = pgTable(
  "owner_onboarding_checklists",
  {
    ...
    proofOfOwnershipUploaded: boolean("proof_of_ownership_uploaded").default(
      false,
    ),
    ...
    utilityAccountsUploaded: boolean("utility_accounts_uploaded").default(
      false,
    ),

    // Setup Tasks
    propertyDetailsCompleted: boolean("property_details_completed").default(
      false,
    ),
    ...
    // Communication Tasks
    introductionCallScheduled: boolean("introduction_call_scheduled").default(
      false,
    ),
    introductionCallCompleted: boolean("introduction_call_completed").default(
      false,
    ),
...
export const maintenanceLog = pgTable(
  "maintenance_log",
  {
    ...
    // Assignment & Cost
    technicianAssigned: varchar("technician_assigned").references(
      () => users.id,
    ),
...
export const aiServiceCyclePredictions = pgTable(
  "ai_service_cycle_predictions",
  {
    ...
    averageCycleMonths: decimal("average_cycle_months", {
      precision: 5,
      scale: 2,
    }),
...
export const maintenanceCostAnalytics = pgTable(
  "maintenance_cost_analytics",
  {
    ...
    gardenCost: decimal("garden_cost", { precision: 10, scale: 2 }).default(
      "0.00",
    ),
    ...
    plumbingCost: decimal("plumbing_cost", { precision: 10, scale: 2 }).default(
      "0.00",
    ),
    hvacCost: decimal("hvac_cost", { precision: 10, scale: 2 }).default("0.00"),
    landscapingCost: decimal("landscaping_cost", {
      precision: 10,
      scale: 2,
    }).default("0.00"),
    otherCost: decimal("other_cost", { precision: 10, scale: 2 }).default(
      "0.00",
    ),
    ...
    averageJobCost: decimal("average_job_cost", {
      precision: 10,
      scale: 2,
    }).default("0.00"),

    // Comparison Metrics
    previousPeriodCost: decimal("previous_period_cost", {
      precision: 10,
      scale: 2,
    }).default("0.00"),
    costChangePercentage: decimal("cost_change_percentage", {
      precision: 5,
      scale: 2,
    }).default("0.00"),
...
export const technicianPerformance = pgTable(
  "technician_performance",
  {
    ...
    averageJobDuration: decimal("average_job_duration", {
      precision: 5,
      scale: 2,
    }).default("0.00"), // in days
    averageCustomerRating: decimal("average_customer_rating", {
      precision: 3,
      scale: 2,
    }).default("0.00"), // 1-5 scale
    onTimeCompletionRate: decimal("on_time_completion_rate", {
      precision: 5,
      scale: 2,
...
export const insertWarrantyAlertSchema = createInsertSchema(
  warrantyAlerts,
).omit({
  id: true,
  createdAt: true,
...
export const insertAiServiceCyclePredictionSchema = createInsertSchema(
...
export const insertMaintenanceCostAnalyticsSchema = createInsertSchema(
...
export const insertTechnicianPerformanceSchema = createInsertSchema(
...
export type AiServiceCyclePrediction =
  typeof aiServiceCyclePredictions.$inferSelect;
export type InsertAiServiceCyclePrediction = z.infer<
  typeof insertAiServiceCyclePredictionSchema
>;

export type MaintenanceCostAnalytics =
  typeof maintenanceCostAnalytics.$inferSelect;
export type InsertMaintenanceCostAnalytics = z.infer<
  typeof insertMaintenanceCostAnalyticsSchema
>;

export type TechnicianPerformance = typeof technicianPerformance.$inferSelect;
export type InsertTechnicianPerformance = z.infer<
  typeof insertTechnicianPerformanceSchema
>;

// ===== CHECK-IN/CHECK-OUT WORKFLOW SYSTEM =====

// Guest check-in records with passport photos and deposit tracking
export const guestCheckIns = pgTable(
  "guest_check_ins",
  {
    id: serial("id").primaryKey(),
    organizationId: varchar("organization_id")
    ...
    // Staff Assignment
    assignedToStaff: varchar("assigned_to_staff")
      .references(() => users.id)
      .notNull(),
    ...
    electricMeterReading: decimal("electric_meter_reading", {
      precision: 10,
      scale: 3,
    }), // kWh reading
...
export const guestCheckOuts = pgTable(
  "guest_check_outs",
  {
    ...
    electricityRatePerKwh: decimal("electricity_rate_per_kwh", {
      precision: 8,
      scale: 4,
    }).default("7.0000"), // THB per kWh
    totalElectricityCharge: decimal("total_electricity_charge", {
      precision: 10,
      scale: 2,
    }), // Total charge in THB
...
export const propertyElectricitySettings = pgTable(
  "property_electricity_settings",
  {
    ...
    // Rate Configuration
    ratePerKwh: decimal("rate_per_kwh", { precision: 8, scale: 4 }).default(
      "7.0000",
    ), // THB per kWh
    currency: varchar("currency").default("THB"),
...
export const checkInOutDemoTasks = pgTable(
...
export const propertyElectricitySettingsRelations = relations(
  propertyElectricitySettings,
  ({ one }) => ({
    organization: one(organizations, {
...
export const checkInOutDemoTasksRelations = relations(
  checkInOutDemoTasks,
  ({ one }) => ({
    organization: one(organizations, {
...
export const insertGuestCheckOutSchema = createInsertSchema(
  guestCheckOuts,
).omit({
  id: true,
  createdAt: true,
...
export const insertPropertyElectricitySettingsSchema = createInsertSchema(
  propertyElectricitySettings,
).omit({
  id: true,
  createdAt: true,
...
export const insertCheckInOutDemoTaskSchema = createInsertSchema(
  checkInOutDemoTasks,
).omit({
  id: true,
  createdAt: true,
...
export type PropertyElectricitySettings =
  typeof propertyElectricitySettings.$inferSelect;
export type InsertPropertyElectricitySettings = z.infer<
  typeof insertPropertyElectricitySettingsSchema
>;

export type CheckInOutDemoTask = typeof checkInOutDemoTasks.$inferSelect;
export type InsertCheckInOutDemoTask = z.infer<
  typeof insertCheckInOutDemoTaskSchema
>;

// Additional Insert Schemas
export const insertPropertyMarketingMediaSchema = createInsertSchema(
  propertyMarketingMedia,
).omit({
  id: true,
  createdAt: true,
...
export const insertPropertyCommissionRuleSchema = createInsertSchema(
  propertyCommissionRules,
).omit({
  id: true,
  createdAt: true,
...
export const insertAgentBookingRequestSchema = createInsertSchema(
  agentBookingRequests,
).omit({
  id: true,
  submittedAt: true,
...
export const insertGuestPortalAccessSchema = createInsertSchema(
  guestPortalAccess,
).omit({
  id: true,
  createdAt: true,
...
export type InsertCommissionEarning = z.infer<
  typeof insertCommissionEarningSchema
>;
...
export type InsertPortfolioAssignment = z.infer<
  typeof insertPortfolioAssignmentSchema
>;
export type PortfolioAssignment = typeof portfolioAssignments.$inferSelect;

// Guest Add-On Service types
export type InsertGuestAddonService = z.infer<
  typeof insertGuestAddonServiceSchema
>;
export type GuestAddonService = typeof guestAddonServices.$inferSelect;
export type InsertGuestAddonBooking = z.infer<
  typeof insertGuestAddonBookingSchema
>;
export type GuestAddonBooking = typeof guestAddonBookings.$inferSelect;
export type InsertGuestPortalAccess = z.infer<
  typeof insertGuestPortalAccessSchema
>;
...
export const propertyReferrals = pgTable("property_referrals", {
  ...
  propertyId: integer("property_id")
    .references(() => properties.id)
    .notNull(),
  referralAgentId: varchar("referral_agent_id")
    .references(() => users.id)
    .notNull(),
  portfolioManagerId: varchar("portfolio_manager_id").references(
    () => users.id,
...
export const referralEarnings = pgTable("referral_earnings", {
  ...
  // Revenue Data
  grossRentalIncome: decimal("gross_rental_income", {
    precision: 10,
    scale: 2,
  }).default("0.00"),
  managementFeeTotal: decimal("management_fee_total", {
    precision: 10,
    scale: 2,
  }).default("0.00"),
  referralCommissionEarned: decimal("referral_commission_earned", {
    precision: 10,
    scale: 2,
  }).default("0.00"),
  ...
  averageReviewScore: decimal("average_review_score", {
    precision: 3,
    scale: 1,
  }).default("0.0"), // 0-5.0
...
export const agentBookings = pgTable("agent_bookings", {
  ...
  organizationId: varchar("organization_id")
    .references(() => organizations.id)
    .notNull(),
  retailAgentId: varchar("retail_agent_id")
    .references(() => users.id)
    .notNull(),
  propertyId: integer("property_id")
    .references(() => properties.id)
...
export const commissionInvoices = pgTable("commission_invoices", {
  ...
  // Financial Summary
  totalCommissions: decimal("total_commissions", {
    precision: 10,
    scale: 2,
  }).notNull(),
  currency: varchar("currency", { length: 3 }).default("THB"),
...
export const commissionInvoiceItems = pgTable("commission_invoice_items", {
  ...
  invoiceId: integer("invoice_id")
    ...
    .notNull(),
  commissionLogId: integer("commission_log_id")
    .references(() => commissionLog.id)
    .notNull(),
...
export const feedbackProcessingLog = pgTable("feedback_processing_log", {
  ...
  feedbackId: integer("feedback_id")
    .references(() => guestFeedback.id)
    .notNull(),
  processingType: varchar("processing_type").notNull(), // auto, manual, ai_nlp
  triggeredRuleId: integer("triggered_rule_id").references(
    () => aiTaskRules.id,
  ),
...
export const recurringServices = pgTable("recurring_services", {
  ...
  assignedPropertyOwner: varchar("assigned_property_owner").references(
    () => users.id,
  ),
...
export const insertRecurringServiceSchema =
  createInsertSchema(recurringServices);
export const insertRecurringServiceBillSchema = createInsertSchema(
  recurringServiceBills,
);
export const insertBillReminderSchema = createInsertSchema(billReminders);
export const insertServicePerformanceSchema =
  createInsertSchema(servicePerformance);
...
export const insertPropertyInternalNotesSchema = createInsertSchema(
...
export type InsertRecurringServiceBill =
  typeof recurringServiceBills.$inferInsert;
...
export const insertFeedbackProcessingLogSchema = createInsertSchema(
...
export type InsertFeedbackProcessingLog =
  typeof feedbackProcessingLog.$inferInsert;
...
export type InsertPropertyInternalNotes = z.infer<
  typeof insertPropertyInternalNotesSchema
>;
export type PropertyInternalNotes = typeof propertyInternalNotes.$inferSelect;
export type InsertAgentMediaAccess = z.infer<
  typeof insertAgentMediaAccessSchema
>;
...
export const addonServiceCatalog = pgTable("addon_service_catalog", {
  ...
  commissionRate: decimal("commission_rate", {
    precision: 5,
    scale: 2,
  }).default("0.00"), // % for internal tracking
  tags: text("tags").array(),
  displayOrder: integer("display_order").default(0),
  createdBy: varchar("created_by")
    .references(() => users.id)
...
export const addonServiceBookings = pgTable("addon_service_bookings", {
  ...
  organizationId: varchar("organization_id")
    ...
    .notNull(),
  serviceId: integer("service_id")
    .references(() => addonServiceCatalog.id, { onDelete: "cascade" })
    .notNull(),
  propertyId: integer("property_id").references(() => properties.id),
  guestName: varchar("guest_name").notNull(),
  guestEmail: varchar("guest_email"),
...
export const addonServiceCommissions = pgTable("addon_service_commissions", {
  ...
  organizationId: varchar("organization_id")
    ...
    .notNull(),
  bookingId: integer("booking_id")
    .references(() => addonServiceBookings.id, { onDelete: "cascade" })
    .notNull(),
  serviceId: integer("service_id")
    .references(() => addonServiceCatalog.id)
    .notNull(),
  category: varchar("category").notNull(),
...
export const addonServiceReports = pgTable("addon_service_reports", {
  ...
  guestChargedRevenue: decimal("guest_charged_revenue", {
    precision: 10,
    scale: 2,
  }).default("0.00"),
  ownerChargedRevenue: decimal("owner_charged_revenue", {
    precision: 10,
    scale: 2,
  }).default("0.00"),
  companyExpenseAmount: decimal("company_expense_amount", {
    precision: 10,
    scale: 2,
  }).default("0.00"),
  complimentaryAmount: decimal("complimentary_amount", {
    precision: 10,
    scale: 2,
  }).default("0.00"),
  averageBookingValue: decimal("average_booking_value", {
    precision: 10,
    scale: 2,
  }).default("0.00"),
...
export const guestMessages = pgTable("guest_messages", {
  ...
  guestLoyaltyId: integer("guest_loyalty_id").references(
    () => guestLoyaltyProfiles.id,
  ),
  bookingId: integer("booking_id").references(() => bookings.id),
  propertyId: integer("property_id").references(() => properties.id),
...
export const insertOwnerActivityTimelineSchema = createInsertSchema(
...
export const insertOwnerPreferencesSchema = createInsertSchema(
  ownerPreferences,
).omit({
  id: true,
  createdAt: true,
...
export const ownerBalanceTracker = pgTable("owner_balance_tracker", {
  ...
  pendingEarnings: decimal("pending_earnings", {
    precision: 12,
    scale: 2,
  }).default("0.00"),
  thisMonthEarnings: decimal("this_month_earnings", {
  ...
  lastPayoutDate: timestamp("last_payout_date"),
  totalLifetimeEarnings: decimal("total_lifetime_earnings", {
    precision: 12,
    scale: 2,
  }).default("0.00"),
  createdAt: timestamp("created_at").defaultNow(),
...
export const payoutRoutingRules = pgTable("payout_routing_rules", {
  ...
  ownerPercentage: decimal("owner_percentage", {
    precision: 5,
    scale: 2,
  }).notNull(),
  managementPercentage: decimal("management_percentage", {
    precision: 5,
    scale: 2,
  }).notNull(),
...
export const utilityBillProcessing = pgTable("utility_bill_processing", {
  ...
  organizationId: varchar("organization_id")
    .references(() => organizations.id)
    .notNull(),
  utilityBillId: integer("utility_bill_id")
    .references(() => utilityBills.id)
    .notNull(),
  processedBy: varchar("processed_by").references(() => users.id),
...
export const enhancedFinanceTransactionLogs = pgTable(
...
export const ownerBalanceTrackerRelations = relations(
  ownerBalanceTracker,
  ({ one }) => ({
    organization: one(organizations, {
      fields: [ownerBalanceTracker.organizationId],
      references: [organizations.id],
    }),
    owner: one(users, {
      fields: [ownerBalanceTracker.ownerId],
      references: [users.id],
    }),
    property: one(properties, {
      fields: [ownerBalanceTracker.propertyId],
      references: [properties.id],
    }),
  }),
);

export const payoutRoutingRulesRelations = relations(
  payoutRoutingRules,
  ({ one }) => ({
    organization: one(organizations, {
      fields: [payoutRoutingRules.organizationId],
      references: [organizations.id],
    }),
    property: one(properties, {
      fields: [payoutRoutingRules.propertyId],
      references: [properties.id],
    }),
    createdByUser: one(users, {
      fields: [payoutRoutingRules.createdBy],
      references: [users.id],
    }),
  }),
);

export const utilityBillProcessingRelations = relations(
  utilityBillProcessing,
  ({ one }) => ({
    organization: one(organizations, {
      fields: [utilityBillProcessing.organizationId],
      references: [organizations.id],
    }),
    utilityBill: one(utilityBills, {
      fields: [utilityBillProcessing.utilityBillId],
      references: [utilityBills.id],
    }),
    processedByUser: one(users, {
      fields: [utilityBillProcessing.processedBy],
      references: [users.id],
    }),
  }),
);

export const enhancedFinanceTransactionLogsRelations = relations(
  enhancedFinanceTransactionLogs,
  ({ one }) => ({
    organization: one(organizations, {
      fields: [enhancedFinanceTransactionLogs.organizationId],
      references: [organizations.id],
    }),
    processedByUser: one(users, {
      fields: [enhancedFinanceTransactionLogs.processedBy],
      references: [users.id],
    }),
  }),
);
...
export const insertPayoutRoutingRuleSchema = createInsertSchema(
  payoutRoutingRules,
).omit({
  id: true,
  createdAt: true,
...
export const insertUtilityBillProcessingSchema = createInsertSchema(
  utilityBillProcessing,
).omit({
  id: true,
  createdAt: true,
...
export const insertEnhancedFinanceTransactionLogSchema = createInsertSchema(
  enhancedFinanceTransactionLogs,
).omit({
  id: true,
...
export type InsertPayoutRoutingRule = z.infer<
  typeof insertPayoutRoutingRuleSchema
>;

export type UtilityBillProcessing = typeof utilityBillProcessing.$inferSelect;
export type InsertUtilityBillProcessing = z.infer<
  typeof insertUtilityBillProcessingSchema
>;

export type EnhancedFinanceTransactionLog =
  typeof enhancedFinanceTransactionLogs.$inferSelect;
export type InsertEnhancedFinanceTransactionLog = z.infer<
  typeof insertEnhancedFinanceTransactionLogSchema
>;

// Owner Dashboard types
export type OwnerActivityTimeline = typeof ownerActivityTimeline.$inferSelect;
export type InsertOwnerActivityTimeline = z.infer<
  typeof insertOwnerActivityTimelineSchema
>;
...
export const taskDepartmentStats = pgTable("task_department_stats", {
  ...
  ownerBillable: decimal("owner_billable", { precision: 12, scale: 2 }).default(
    "0",
  ),
  guestBillable: decimal("guest_billable", { precision: 12, scale: 2 }).default(
    "0",
  ),
  companyExpense: decimal("company_expense", {
    precision: 12,
    scale: 2,
  }).default("0"),
...
export const insertTaskAutoGenRuleSchema = createInsertSchema(
  taskAutoGenRules,
).omit({
  id: true,
  createdAt: true,
...
export const insertPropertyTaskBillingSchema = createInsertSchema(
  propertyTaskBilling,
).omit({
  id: true,
  createdAt: true,
...
export const insertTaskDepartmentStatsSchema = createInsertSchema(
  taskDepartmentStats,
).omit({
  id: true,
  createdAt: true,
...
export const insertTaskNotificationRuleSchema = createInsertSchema(
...
export type InsertPropertyTaskBilling = z.infer<
  typeof insertPropertyTaskBillingSchema
>;
...
export type InsertTaskDepartmentStats = z.infer<
  typeof insertTaskDepartmentStatsSchema
>;
...
export type InsertTaskNotificationRule = z.infer<
  typeof insertTaskNotificationRuleSchema
>;
export type OwnerPreferences = typeof ownerPreferences.$inferSelect;
export type InsertOwnerPreferences = z.infer<
  typeof insertOwnerPreferencesSchema
>;
...
export const propertyReferralsRelations = relations(
  propertyReferrals,
  ({ one }) => ({
    property: one(properties, {
...
export const referralProgramRulesRelations = relations(
...
export const insertPropertyReferralSchema = createInsertSchema(
  propertyReferrals,
).omit({
  id: true,
  createdAt: true,
...
export const insertReferralProgramRulesSchema = createInsertSchema(
  referralProgramRules,
).omit({
  id: true,
  createdAt: true,
...
export const insertPropertyAgentsSchema = createInsertSchema(
  propertyAgents,
).omit({
  id: true,
  createdAt: true,
...
export const staffSalaries = pgTable("staff_salaries", {
  ...
  taskBonusAmount: decimal("task_bonus_amount", {
    precision: 10,
    scale: 2,
  }).default("0"),
  ...
  tipsReceived: decimal("tips_received", { precision: 10, scale: 2 }).default(
    "0",
  ),
  additionalIncome: decimal("additional_income", {
    precision: 10,
    scale: 2,
  }).default("0"),
...
export const taskCompletions = pgTable("task_completions", {
  ...
  totalExpenseAmount: decimal("total_expense_amount", {
    precision: 10,
    scale: 2,
  }).default("0"),
...
export const insertTaskChecklistsSchema = createInsertSchema(
  taskChecklists,
).omit({
  id: true,
  createdAt: true,
...
export const insertTaskCompletionsSchema = createInsertSchema(
  taskCompletions,
).omit({
  id: true,
  createdAt: true,
...
export type InsertPropertyReferral = z.infer<
  typeof insertPropertyReferralSchema
>;
...
export type InsertReferralProgramRule = z.infer<
  typeof insertReferralProgramRulesSchema
>;
...
export const balanceResetAuditRelations = relations(
  balanceResetAudit,
  ({ one }) => ({
    user: one(users, {
...
export const insertBalanceResetAuditSchema = createInsertSchema(
  balanceResetAudit,
).omit({
  id: true,
  createdAt: true,
...
export type InsertBalanceResetAudit = z.infer<
  typeof insertBalanceResetAuditSchema
>;

// Utility Providers Relations
export const utilityProvidersRelations = relations(
  utilityProviders,
  ({ one, many }) => ({
    organization: one(organizations, {
...
export const customExpenseCategoriesRelations = relations(
...
export const propertyUtilitySettingsRelations = relations(
...
export const propertyCustomExpensesRelations = relations(
...
export const insertUtilityProviderSchema = createInsertSchema(
  utilityProviders,
).omit({
  id: true,
  createdAt: true,
...
export const insertCustomExpenseCategorySchema = createInsertSchema(
  customExpenseCategories,
).omit({
  id: true,
  createdAt: true,
...
export const insertPropertyUtilitySettingsSchema = createInsertSchema(
  propertyUtilitySettings,
).omit({
  id: true,
  createdAt: true,
...
export const insertPropertyCustomExpensesSchema = createInsertSchema(
  propertyCustomExpenses,
).omit({
  id: true,
  createdAt: true,
...
export type InsertCustomExpenseCategory = z.infer<
  typeof insertCustomExpenseCategorySchema
>;
export type PropertyUtilitySettings =
  typeof propertyUtilitySettings.$inferSelect;
export type InsertPropertyUtilitySettings = z.infer<
  typeof insertPropertyUtilitySettingsSchema
>;
export type PropertyCustomExpenses = typeof propertyCustomExpenses.$inferSelect;
export type InsertPropertyCustomExpenses = z.infer<
  typeof insertPropertyCustomExpensesSchema
>;
...
export const insertCommissionInvoicesSchema = createInsertSchema(
  commissionInvoices,
).omit({
  id: true,
  createdAt: true,
...
export const insertCommissionInvoiceItemsSchema = createInsertSchema(
...
export type InsertCommissionInvoice = z.infer<
  typeof insertCommissionInvoicesSchema
>;
export type CommissionInvoiceItem = typeof commissionInvoiceItems.$inferSelect;
export type InsertCommissionInvoiceItem = z.infer<
  typeof insertCommissionInvoiceItemsSchema
>;
...
export const insertGuestLoyaltyProfileSchema = createInsertSchema(
...
export const insertMessagingTriggerSchema = createInsertSchema(
  messagingTriggers,
).omit({
  id: true,
  createdAt: true,
...
export const insertSmartReplySuggestionSchema = createInsertSchema(
...
export const insertAiMessageAnalysisSchema = createInsertSchema(
  aiMessageAnalysis,
).omit({
  id: true,
  createdAt: true,
...
export const insertMessageDeliverySchema = createInsertSchema(
  messageDeliveries,
).omit({
  id: true,
  createdAt: true,
...
export type InsertGuestLoyaltyProfile = z.infer<
  typeof insertGuestLoyaltyProfileSchema
>;
...
export type InsertMessagingTrigger = z.infer<
  typeof insertMessagingTriggerSchema
>;

// ===== TASK CHECKLISTS & PROOF UPLOAD TYPES =====

// Task Checklists
export const insertTaskChecklistSchema = createInsertSchema(
  taskChecklists,
).omit({
  id: true,
  createdAt: true,
...
// Property Guides
export const insertPropertyGuideSchema = createInsertSchema(
  propertyGuides,
).omit({
  id: true,
  createdAt: true,
...
// Task Proof Uploads
export const insertTaskProofUploadSchema = createInsertSchema(
  taskProofUploads,
).omit({
  id: true,
  uploadedAt: true,
...
// Monthly Export Logs
export const insertMonthlyExportLogSchema = createInsertSchema(
  monthlyExportLogs,
).omit({
  id: true,
  exportedAt: true,
...
export type InsertMonthlyExportLog = z.infer<
  typeof insertMonthlyExportLogSchema
>;
export type SmartReplySuggestion = typeof smartReplySuggestions.$inferSelect;
export type InsertSmartReplySuggestion = z.infer<
  typeof insertSmartReplySuggestionSchema
>;
export type AiMessageAnalysis = typeof aiMessageAnalysis.$inferSelect;
export type InsertAiMessageAnalysis = z.infer<
  typeof insertAiMessageAnalysisSchema
>;
...
export const monthlyPayrollRecords = pgTable(
  "monthly_payroll_records",
  {
    ...
    // Salary Components
    baseSalary: decimal("base_salary", { precision: 10, scale: 2 }).default(
      "0",
    ),
    overtimePay: decimal("overtime_pay", { precision: 10, scale: 2 }).default(
      "0",
    ),
    taskBonuses: decimal("task_bonuses", { precision: 10, scale: 2 }).default(
      "0",
    ),
    commissions: decimal("commissions", { precision: 10, scale: 2 }).default(
      "0",
    ), // bike rentals, tour sales, etc.
    otherBonuses: decimal("other_bonuses", { precision: 10, scale: 2 }).default(
      "0",
    ),

    // Deductions
    advanceSalaryDeductions: decimal("advance_salary_deductions", {
      precision: 10,
      scale: 2,
    }).default("0"),
...
export const taskPerformanceLogs = pgTable(
...
export const attendanceRecords = pgTable(
  "attendance_records",
  {
    ...
    hoursWorked: decimal("hours_worked", { precision: 5, scale: 2 }).default(
      "0",
    ),
...
export const paySlips = pgTable(
  "pay_slips",
  {
    ...
    payrollRecordId: integer("payroll_record_id")
      .references(() => monthlyPayrollRecords.id)
      .notNull(),
    staffId: varchar("staff_id")
      .references(() => users.id)
      .notNull(),
...
export const insertMonthlyPayrollRecordSchema = createInsertSchema(
...
export const insertTaskPerformanceLogSchema = createInsertSchema(
  taskPerformanceLogs,
).omit({
  id: true,
  createdAt: true,
...
export const insertStaffCommissionSchema = createInsertSchema(
  staffCommissions,
).omit({
  id: true,
  createdAt: true,
...
export type InsertMonthlyPayrollRecord = z.infer<
  typeof insertMonthlyPayrollRecordSchema
>;
export type TaskPerformanceLog = typeof taskPerformanceLogs.$inferSelect;
export type InsertTaskPerformanceLog = z.infer<
  typeof insertTaskPerformanceLogSchema
>;
...
export const staffAdvanceRequests = pgTable(
...
export const staffOvertimeLogs = pgTable(
  "staff_overtime_logs",
  {
    id: serial("id").primaryKey(),
    organizationId: varchar("organization_id")
...
export const staffOvertimeSettings = pgTable(
  "staff_overtime_settings",
  {
    ...
    // Overtime Rules
    regularHourlyRate: decimal("regular_hourly_rate", {
      precision: 10,
      scale: 2,
    }),
    overtimeMultiplier: decimal("overtime_multiplier", {
      precision: 3,
      scale: 2,
    }).default("1.5"), // 1.5x rate
    emergencyMultiplier: decimal("emergency_multiplier", {
      precision: 3,
      scale: 2,
    }).default("2.0"), // 2x rate
    ...
    defaultCompensationType: varchar("default_compensation_type").default(
      "overtime_pay",
    ), // overtime_pay, time_off_credit
    allowStaffChoice: boolean("allow_staff_choice").default(true),

    // Time Off Credit Rules
    timeOffCreditRate: decimal("time_off_credit_rate", {
      precision: 3,
      scale: 2,
    }).default("1.0"), // 1:1 ratio
    maxTimeOffAccumulation: decimal("max_time_off_accumulation", {
      precision: 4,
      scale: 2,
    }).default("40.0"), // 40 hours max
...
export const staffMonthlySummary = pgTable(
  "staff_monthly_summary",
  {
    ...
    approvedAdvances: decimal("approved_advances", {
      precision: 10,
      scale: 2,
    }).default("0"),
    pendingAdvances: decimal("pending_advances", {
      precision: 10,
      scale: 2,
    }).default("0"),
    remainingAdvanceBalance: decimal("remaining_advance_balance", {
      precision: 10,
      scale: 2,
    }).default("0"),
    ...
    approvedOvertimeHours: decimal("approved_overtime_hours", {
      precision: 4,
      scale: 2,
    }).default("0"),
    pendingOvertimeHours: decimal("pending_overtime_hours", {
      precision: 4,
      scale: 2,
    }).default("0"),
    overtimeEarnings: decimal("overtime_earnings", {
      precision: 10,
      scale: 2,
    }).default("0"),
    timeOffCredits: decimal("time_off_credits", {
      precision: 4,
      scale: 2,
    }).default("0"),
...
export const insertStaffAdvanceRequestSchema = createInsertSchema(
...
export const insertStaffClockEntrySchema = createInsertSchema(
  staffClockEntries,
).omit({
  id: true,
  createdAt: true,
...
export const insertStaffOvertimeLogSchema = createInsertSchema(
  staffOvertimeLogs,
).omit({
  id: true,
  createdAt: true,
...
export const insertStaffOvertimeSettingsSchema = createInsertSchema(
...
export const insertStaffMonthlySummarySchema = createInsertSchema(
  staffMonthlySummary,
).omit({
  id: true,
  lastUpdated: true,
...
export type InsertStaffAdvanceRequest = z.infer<
  typeof insertStaffAdvanceRequestSchema
>;
...
export type InsertStaffOvertimeLog = z.infer<
  typeof insertStaffOvertimeLogSchema
>;
export type StaffOvertimeSettings = typeof staffOvertimeSettings.$inferSelect;
export type InsertStaffOvertimeSettings = z.infer<
  typeof insertStaffOvertimeSettingsSchema
>;
export type StaffMonthlySummary = typeof staffMonthlySummary.$inferSelect;
export type InsertStaffMonthlySummary = z.infer<
  typeof insertStaffMonthlySummarySchema
>;
...
export const portfolioManagerCommissions = pgTable(
  "portfolio_manager_commissions",
  {
    ...
    managementFees: decimal("management_fees", {
      precision: 12,
      scale: 2,
    }).notNull(),
    commissionRate: decimal("commission_rate", {
...
export const referralAgentCommissionLogs = pgTable(
  "referral_agent_commission_logs",
  {
    ...
    // Revenue Data
    managementRevenue: decimal("management_revenue", {
      precision: 10,
      scale: 2,
    }).notNull(),
    commissionRate: decimal("commission_rate", {
...
// Invoice Line Items
export const universalInvoiceLineItems = pgTable(
  "universal_invoice_line_items",
  {
    ...
    organizationId: varchar("organization_id")
      ...
      .notNull(),
    invoiceId: integer("invoice_id")
      .references(() => universalInvoices.id)
      .notNull(),
...
export const insertStaffPayrollRecordSchema = createInsertSchema(
  staffPayrollRecords,
).omit({
  id: true,
  createdAt: true,
...
export const insertPortfolioManagerCommissionSchema = createInsertSchema(
...
export const insertReferralAgentCommissionLogSchema = createInsertSchema(
...
export const insertUniversalInvoiceSchema = createInsertSchema(
  universalInvoices,
).omit({
  id: true,
  createdAt: true,
...
export const insertUniversalInvoiceLineItemSchema = createInsertSchema(
...
export const insertPaymentConfirmationSchema = createInsertSchema(
...
export type InsertStaffPayrollRecord = z.infer<
  typeof insertStaffPayrollRecordSchema
>;
export type PortfolioManagerCommission =
  typeof portfolioManagerCommissions.$inferSelect;
export type InsertPortfolioManagerCommission = z.infer<
  typeof insertPortfolioManagerCommissionSchema
>;
export type ReferralAgentCommissionLog =
  typeof referralAgentCommissionLogs.$inferSelect;
export type InsertReferralAgentCommissionLog = z.infer<
  typeof insertReferralAgentCommissionLogSchema
>;
export type UniversalInvoice = typeof universalInvoices.$inferSelect;
export type InsertUniversalInvoice = z.infer<
  typeof insertUniversalInvoiceSchema
>;
export type UniversalInvoiceLineItem =
  typeof universalInvoiceLineItems.$inferSelect;
export type InsertUniversalInvoiceLineItem = z.infer<
  typeof insertUniversalInvoiceLineItemSchema
>;
export type PaymentConfirmation = typeof paymentConfirmations.$inferSelect;
export type InsertPaymentConfirmation = z.infer<
  typeof insertPaymentConfirmationSchema
>;

// ===== ADD-ON SERVICES ENGINE SCHEMAS AND TYPES =====

// Insert schemas for Add-On Services Engine
export const insertAddonServiceCatalogSchema = createInsertSchema(
  addonServiceCatalog,
).omit({
  id: true,
  createdAt: true,
...
export const insertAddonServiceBookingSchema = createInsertSchema(
...
export const insertAddonServiceCategorySchema = createInsertSchema(
...
export const insertAddonServiceCommissionSchema = createInsertSchema(
...
export const insertAddonServiceReportSchema = createInsertSchema(
  addonServiceReports,
).omit({
  id: true,
  createdAt: true,
...
export const insertAddonServiceAvailabilitySchema = createInsertSchema(
...
export const insertAddonBillingRuleSchema = createInsertSchema(
  addonBillingRules,
).omit({
  id: true,
  createdAt: true,
...
export type InsertAddonServiceCatalog = z.infer<
  typeof insertAddonServiceCatalogSchema
>;
export type AddonServiceBooking = typeof addonServiceBookings.$inferSelect;
export type InsertAddonServiceBooking = z.infer<
  typeof insertAddonServiceBookingSchema
>;
export type AddonServiceCategory = typeof addonServiceCategories.$inferSelect;
export type InsertAddonServiceCategory = z.infer<
  typeof insertAddonServiceCategorySchema
>;
export type AddonServiceCommission =
  typeof addonServiceCommissions.$inferSelect;
export type InsertAddonServiceCommission = z.infer<
  typeof insertAddonServiceCommissionSchema
>;
export type AddonServiceReport = typeof addonServiceReports.$inferSelect;
export type InsertAddonServiceReport = z.infer<
  typeof insertAddonServiceReportSchema
>;
export type AddonServiceAvailability =
  typeof addonServiceAvailability.$inferSelect;
export type InsertAddonServiceAvailability = z.infer<
  typeof insertAddonServiceAvailabilitySchema
>;
export type AddonBillingRule = typeof addonBillingRules.$inferSelect;
export type InsertAddonBillingRule = z.infer<
  typeof insertAddonBillingRuleSchema
>;
...
export const liveBookingCalendar = pgTable("live_booking_calendar", {
  ...
  ownerSplit: decimal("owner_split", { precision: 5, scale: 2 }).default(
    "70.00",
  ), // percentage
  managementSplit: decimal("management_split", {
    precision: 5,
    scale: 2,
  }).default("30.00"), // percentage
  ...
  // Commission Tracking
  agentCommissionApplicable: boolean("agent_commission_applicable").default(
    false,
  ),
  referralAgentId: varchar("referral_agent_id").references(() => users.id),
  retailAgentId: varchar("retail_agent_id").references(() => users.id),
  agentCommissionAmount: decimal("agent_commission_amount", {
    precision: 10,
    scale: 2,
  }).default("0.00"),
...
export const propertySearchIndex = pgTable("property_search_index", {
  ...
  // Pricing Information
  baseNightlyRate: decimal("base_nightly_rate", {
    precision: 10,
    scale: 2,
  }).notNull(),
  ...
  standardCommissionRate: decimal("standard_commission_rate", {
    precision: 5,
    scale: 2,
  }).default("10.00"),
  specialCommissionRate: decimal("special_commission_rate", {
    precision: 5,
    scale: 2,
  }),
  ...
  averageOccupancyRate: decimal("average_occupancy_rate", {
    precision: 5,
    scale: 2,
  }),
  averageReviewScore: decimal("average_review_score", {
...
export const agentBookingEnquiries = pgTable("agent_booking_enquiries", {
  ...
  currency: varchar("currency", { length: 3 }).default("THB"),
  calculatedCommission: decimal("calculated_commission", {
    precision: 10,
    scale: 2,
  }),
  commissionRate: decimal("commission_rate", {
...
export const propertyOccupancyAnalytics = pgTable(
  "property_occupancy_analytics",
  {
    ...
    occupancyRate: decimal("occupancy_rate", {
      precision: 5,
      scale: 2,
    }).notNull(),
    ...
    averageNightlyRate: decimal("average_nightly_rate", {
      precision: 10,
      scale: 2,
    }).default("0.00"),
    revenuePerAvailableNight: decimal("revenue_per_available_night", {
      precision: 10,
      scale: 2,
    }).default("0.00"),
    ...
    // Booking Metrics
    totalBookings: integer("total_bookings").default(0),
    averageStayDuration: decimal("average_stay_duration", {
      precision: 4,
      scale: 2,
    }).default("0.00"),
    averageGuestCount: decimal("average_guest_count", {
      precision: 4,
      scale: 2,
    }).default("0.00"),
    ...
    bookingLeadTime: decimal("booking_lead_time", {
      precision: 5,
      scale: 2,
    }).default("0.00"), // days
...
export const liveBookingCalendarRelations = relations(
  liveBookingCalendar,
  ({ one }) => ({
    property: one(properties, {
...
export const propertySearchIndexRelations = relations(
  propertySearchIndex,
  ({ one }) => ({
    property: one(properties, {
...
export const agentBookingEnquiriesRelations = relations(
...
export const insertLiveBookingCalendarSchema = createInsertSchema(
  liveBookingCalendar,
).omit({
  id: true,
  createdAt: true,
...
export const insertPropertyAvailabilitySchema = createInsertSchema(
  propertyAvailability,
).omit({
  id: true,
  createdAt: true,
...
export const insertAgentSearchPreferencesSchema = createInsertSchema(
...
export const insertPropertySearchIndexSchema = createInsertSchema(
  propertySearchIndex,
).omit({
  id: true,
  createdAt: true,
...
export const insertAgentBookingEnquiriesSchema = createInsertSchema(
  agentBookingEnquiries,
).omit({
  id: true,
  createdAt: true,
...
export const insertBookingPlatformSyncSchema = createInsertSchema(
  bookingPlatformSync,
).omit({
  id: true,
  createdAt: true,
...
export const insertPropertyOccupancyAnalyticsSchema = createInsertSchema(
...
export type InsertLiveBookingCalendar = z.infer<
  typeof insertLiveBookingCalendarSchema
>;
export type PropertyAvailability = typeof propertyAvailability.$inferSelect;
export type InsertPropertyAvailability = z.infer<
  typeof insertPropertyAvailabilitySchema
>;
export type AgentSearchPreferences = typeof agentSearchPreferences.$inferSelect;
export type InsertAgentSearchPreferences = z.infer<
  typeof insertAgentSearchPreferencesSchema
>;
export type PropertySearchIndex = typeof propertySearchIndex.$inferSelect;
export type InsertPropertySearchIndex = z.infer<
  typeof insertPropertySearchIndexSchema
>;
export type AgentBookingEnquiries = typeof agentBookingEnquiries.$inferSelect;
export type InsertAgentBookingEnquiries = z.infer<
  typeof insertAgentBookingEnquiriesSchema
>;
export type BookingPlatformSync = typeof bookingPlatformSync.$inferSelect;
export type InsertBookingPlatformSync = z.infer<
  typeof insertBookingPlatformSyncSchema
>;
export type PropertyOccupancyAnalytics =
  typeof propertyOccupancyAnalytics.$inferSelect;
export type InsertPropertyOccupancyAnalytics = z.infer<
  typeof insertPropertyOccupancyAnalyticsSchema
>;
...
export const guestActivityTimeline = pgTable("guest_activity_timeline", {
  ...
  guestSessionId: integer("guest_session_id")
    .references(() => guestPortalSessions.id)
    .notNull(),
  bookingId: integer("booking_id")
    .references(() => bookings.id)
    .notNull(),
...
export const guestAddonServiceRequests = pgTable(
  "guest_addon_service_requests",
  {
    ...
    // Service Provider
    serviceProviderId: varchar("service_provider_id").references(
      () => users.id,
    ), // Staff assigned
...
export const guestPropertyLocalInfo = pgTable("guest_property_local_info", {
  ...
  distanceFromProperty: decimal("distance_from_property", {
    precision: 5,
    scale: 2,
  }), // km
...
export const insertGuestPortalSessionSchema = createInsertSchema(
  guestPortalSessions,
).omit({
  id: true,
  createdAt: true,
...
export const insertGuestActivityTimelineSchema = createInsertSchema(
...
export const insertGuestAiFaqKnowledgeSchema = createInsertSchema(
  guestAiFaqKnowledge,
).omit({
  id: true,
  createdAt: true,
...
export const insertGuestAddonServiceRequestSchema = createInsertSchema(
...
export const insertGuestPropertyLocalInfoSchema = createInsertSchema(
...
export const insertGuestMaintenanceReportSchema = createInsertSchema(
...
export type InsertGuestPortalSession = z.infer<
  typeof insertGuestPortalSessionSchema
>;
export type GuestActivityTimeline = typeof guestActivityTimeline.$inferSelect;
export type InsertGuestActivityTimeline = z.infer<
  typeof insertGuestActivityTimelineSchema
>;

export type GuestAiFaqKnowledge = typeof guestAiFaqKnowledge.$inferSelect;
export type InsertGuestAiFaqKnowledge = z.infer<
  typeof insertGuestAiFaqKnowledgeSchema
>;
export type GuestAddonServiceRequest =
  typeof guestAddonServiceRequests.$inferSelect;
export type InsertGuestAddonServiceRequest = z.infer<
  typeof insertGuestAddonServiceRequestSchema
>;
export type GuestPropertyLocalInfo = typeof guestPropertyLocalInfo.$inferSelect;
export type InsertGuestPropertyLocalInfo = z.infer<
  typeof insertGuestPropertyLocalInfoSchema
>;
export type GuestMaintenanceReport =
  typeof guestMaintenanceReports.$inferSelect;
export type InsertGuestMaintenanceReport = z.infer<
  typeof insertGuestMaintenanceReportSchema
>;
...
export type InsertEnhancedAiSuggestion =
  typeof enhancedAiSuggestions.$inferInsert;
...
export type InsertFastActionSuggestion =
  typeof fastActionSuggestions.$inferInsert;
...
export const ownerBalanceTrackers = pgTable("owner_balance_trackers", {
  ...
  netBalance: decimal("net_balance", { precision: 12, scale: 2 }).default(
    "0.00",
  ),
...
export const ownerPayoutRequests = pgTable("owner_payout_requests", {
  ...
  ownerId: varchar("owner_id")
    ...
    .notNull(),
  propertyId: integer("property_id").references(() => properties.id),
  balanceTrackerId: integer("balance_tracker_id").references(
...
export const ownerPaymentLogs = pgTable("owner_payment_logs", {
  ...
  ownerId: varchar("owner_id")
    ...
    .notNull(),
  propertyId: integer("property_id").references(() => properties.id),
  payoutRequestId: integer("payout_request_id").references(
...
export const propertyPayoutSettings = pgTable("property_payout_settings", {
  ...
  referralAgentPayoutFrequency: varchar(
...
export const insertOwnerBalanceTrackerSchema = createInsertSchema(
...
export const insertOwnerPayoutRequestSchema = createInsertSchema(
  ownerPayoutRequests,
).omit({
  id: true,
  createdAt: true,
...
export const insertOwnerPaymentLogSchema = createInsertSchema(
  ownerPaymentLogs,
).omit({
  id: true,
  createdAt: true,
...
export const insertOwnerDebtTrackerSchema = createInsertSchema(
  ownerDebtTrackers,
).omit({
  id: true,
  createdAt: true,
...
export const insertPropertyPayoutSettingsSchema = createInsertSchema(
...
export type InsertOwnerBalanceTracker = z.infer<
  typeof insertOwnerBalanceTrackerSchema
>;
export type OwnerPayoutRequest = typeof ownerPayoutRequests.$inferSelect;
export type InsertOwnerPayoutRequest = z.infer<
  typeof insertOwnerPayoutRequestSchema
>;
...
export type InsertOwnerDebtTracker = z.infer<
  typeof insertOwnerDebtTrackerSchema
>;
export type PropertyPayoutSettings = typeof propertyPayoutSettings.$inferSelect;
export type InsertPropertyPayoutSettings = z.infer<
  typeof insertPropertyPayoutSettingsSchema
>;
...
export const platformRoutingRules = pgTable("platform_routing_rules", {
  ...
  defaultOwnerPercentage: decimal("default_owner_percentage", {
    precision: 5,
    scale: 2,
  }).notNull(), // 70.00 for 70%
  defaultManagementPercentage: decimal("default_management_percentage", {
    precision: 5,
    scale: 2,
  }).notNull(), // 30.00 for 30%
...
export const propertyPlatformRules = pgTable("property_platform_rules", {
  ...
  propertyId: integer("property_id")
    .references(() => properties.id)
    .notNull(),
  platformRuleId: integer("platform_rule_id")
    .references(() => platformRoutingRules.id)
    .notNull(),

  // Override Settings
  overrideOwnerPercentage: decimal("override_owner_percentage", {
    precision: 5,
    scale: 2,
  }),
  overrideManagementPercentage: decimal("override_management_percentage", {
    precision: 5,
    scale: 2,
  }),
...
export const bookingPlatformRouting = pgTable("booking_platform_routing", {
  ...
  actualOwnerPercentage: decimal("actual_owner_percentage", {
    precision: 5,
    scale: 2,
  }).notNull(),
  actualManagementPercentage: decimal("actual_management_percentage", {
    precision: 5,
    scale: 2,
  }).notNull(),
  ...
  // Financial Breakdown
  totalBookingAmount: decimal("total_booking_amount", {
    precision: 12,
    scale: 2,
  }).notNull(),
  ownerAmount: decimal("owner_amount", { precision: 12, scale: 2 }).notNull(),
  managementAmount: decimal("management_amount", {
    precision: 12,
    scale: 2,
  }).notNull(),
...
export const staffClockSettings = pgTable("staff_clock_settings", {
  ...
  standardWorkDays: jsonb("standard_work_days").default(
  ...
  emergencyCalloutRate: decimal("emergency_callout_rate", {
    precision: 8,
    scale: 2,
  }).default("50.00"),
  weekendWorkMultiplier: decimal("weekend_work_multiplier", {
    precision: 3,
    scale: 2,
  }).default("1.25"),
  holidayWorkMultiplier: decimal("holiday_work_multiplier", {
    precision: 3,
    scale: 2,
  }).default("2.0"),

  // Clock Policies
  allowGeolocationTracking: boolean("allow_geolocation_tracking").default(
    false,
  ),
  ...
  allowManualTimeAdjustment: boolean("allow_manual_time_adjustment").default(
    true,
  ),
...
export const staffTimeSummaries = pgTable("staff_time_summaries", {
  ...
  regularHoursPay: decimal("regular_hours_pay", {
    precision: 10,
    scale: 2,
  }).default("0.00"),
  overtimePay: decimal("overtime_pay", { precision: 10, scale: 2 }).default(
  ...
  emergencyPay: decimal("emergency_pay", { precision: 10, scale: 2 }).default(
    "0.00",
  ),
...
export const insertPlatformRoutingRuleSchema = createInsertSchema(
...
export const insertPropertyPlatformRuleSchema = createInsertSchema(
...
export const insertBookingPlatformRoutingSchema = createInsertSchema(
...
export const insertRoutingAuditLogSchema = createInsertSchema(
  routingAuditLog,
).omit({
  id: true,
  createdAt: true,
...
export const insertStaffWorkClockSchema = createInsertSchema(
  staffWorkClocks,
).omit({
  id: true,
  createdAt: true,
...
export const insertStaffClockSettingsSchema = createInsertSchema(
  staffClockSettings,
).omit({
  id: true,
  createdAt: true,
...
export const insertStaffTimeSummarySchema = createInsertSchema(
  staffTimeSummaries,
).omit({
  id: true,
  createdAt: true,
...
export const insertStaffClockAuditLogSchema = createInsertSchema(
  staffClockAuditLog,
).omit({
  id: true,
  createdAt: true,
...
export type InsertStaffClockSettings = z.infer<
  typeof insertStaffClockSettingsSchema
>;

export type StaffTimeSummary = typeof staffTimeSummaries.$inferSelect;
export type InsertStaffTimeSummary = z.infer<
  typeof insertStaffTimeSummarySchema
>;

export type StaffClockAuditLog = typeof staffClockAuditLog.$inferSelect;
export type InsertStaffClockAuditLog = z.infer<
  typeof insertStaffClockAuditLogSchema
>;
...
export const maintenanceApprovalLogs = pgTable("maintenance_approval_logs", {
  ...
  suggestionId: integer("suggestion_id")
    .references(() => maintenanceSuggestions.id)
    .notNull(),
...
export const maintenanceSuggestionSettings = pgTable(
  "maintenance_suggestion_settings",
  {
    ...
    // Approval Timeouts
    defaultApprovalTimeoutDays: integer(
      "default_approval_timeout_days",
    ).default(7),
    urgentApprovalTimeoutDays: integer("urgent_approval_timeout_days").default(
      3,
    ),
    ...
    notifyManagersOnApproval: boolean("notify_managers_on_approval").default(
      true,
    ),
    notifyStaffOnTaskCreation: boolean("notify_staff_on_task_creation").default(
      true,
    ),
    ...
    multipleQuotesThreshold: decimal("multiple_quotes_threshold", {
      precision: 10,
      scale: 2,
    }).default("500.00"),
    ...
    requireDetailedDescription: boolean("require_detailed_description").default(
      true,
    ),
...
export const serviceVendors = pgTable("service_vendors", {
  ...
  preferredPaymentMethod: varchar("preferred_payment_method").default(
    "bank_transfer",
  ),
...
export const serviceBookings = pgTable("service_bookings", {
  ...
  organizationId: varchar("organization_id")
    ...
    .notNull(),
  serviceId: integer("service_id")
    .references(() => marketplaceServices.id)
    .notNull(),
  propertyId: integer("property_id")
    .references(() => properties.id)
    .notNull(),
...
export const maintenanceTimelineEntries = pgTable(
...
export const insertMaintenanceSuggestionSchema = createInsertSchema(
...
export const insertMaintenanceApprovalLogSchema = createInsertSchema(
...
export const insertMaintenanceSuggestionSettingsSchema = createInsertSchema(
...
export const insertMaintenanceTimelineEntrySchema = createInsertSchema(
...
export type InsertMaintenanceSuggestion = z.infer<
  typeof insertMaintenanceSuggestionSchema
>;

export type MaintenanceApprovalLog =
  typeof maintenanceApprovalLogs.$inferSelect;
export type InsertMaintenanceApprovalLog = z.infer<
  typeof insertMaintenanceApprovalLogSchema
>;

export type MaintenanceSuggestionSettings =
  typeof maintenanceSuggestionSettings.$inferSelect;
export type InsertMaintenanceSuggestionSettings = z.infer<
  typeof insertMaintenanceSuggestionSettingsSchema
>;

export type MaintenanceTimelineEntry =
  typeof maintenanceTimelineEntries.$inferSelect;
export type InsertMaintenanceTimelineEntry = z.infer<
  typeof insertMaintenanceTimelineEntrySchema
>;

// ===== SERVICE MARKETPLACE INSERT SCHEMAS =====

export const insertServiceVendorSchema = createInsertSchema(
  serviceVendors,
).omit({
  id: true,
  createdAt: true,
...
export const insertMarketplaceServiceSchema = createInsertSchema(
  marketplaceServices,
).omit({
  id: true,
  createdAt: true,
...
export const insertServiceBookingSchema = createInsertSchema(
  serviceBookings,
).omit({
  id: true,
  createdAt: true,
...
export const insertServiceReviewSchema = createInsertSchema(
  serviceReviews,
).omit({
  id: true,
  createdAt: true,
...
export const insertServiceAnalyticsSchema = createInsertSchema(
  serviceAnalytics,
).omit({
  id: true,
  createdAt: true,
...
export type InsertMarketplaceService = z.infer<
  typeof insertMarketplaceServiceSchema
>;
...
export type InsertServiceAnalytics = z.infer<
  typeof insertServiceAnalyticsSchema
>;
...
export const insertGuestAiRecommendationSchema = createInsertSchema(
  guestAiRecommendations,
).omit({
  id: true,
  createdAt: true,
...
export const insertGuestServiceTimelineSchema = createInsertSchema(
  guestServiceTimeline,
).omit({
  id: true,
  createdAt: true,
...
export const insertPropertyAmenitySchema = createInsertSchema(
  propertyAmenities,
).omit({
  id: true,
  createdAt: true,
...
export type InsertGuestAiRecommendation = z.infer<
  typeof insertGuestAiRecommendationSchema
>;

export type GuestServiceTimeline = typeof guestServiceTimeline.$inferSelect;
export type InsertGuestServiceTimeline = z.infer<
  typeof insertGuestServiceTimelineSchema
>;
...
export const insertGuestCheckoutSurveySchema = createInsertSchema(
  guestCheckoutSurveys,
).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
...
export const insertSurveySettingsSchema = createInsertSchema(
  surveySettings,
).omit({
  id: true,
  createdAt: true,
...
export const insertSurveyAnalyticsSchema = createInsertSchema(
  surveyAnalytics,
).omit({
  id: true,
  createdAt: true,
...
export type InsertGuestCheckoutSurvey = z.infer<
  typeof insertGuestCheckoutSurveySchema
>;
...
export type InsertPlatformRoutingRule = z.infer<
  typeof insertPlatformRoutingRuleSchema
>;
export type PropertyPlatformRule = typeof propertyPlatformRules.$inferSelect;
export type InsertPropertyPlatformRule = z.infer<
  typeof insertPropertyPlatformRuleSchema
>;
export type BookingPlatformRouting = typeof bookingPlatformRouting.$inferSelect;
export type InsertBookingPlatformRouting = z.infer<
  typeof insertBookingPlatformRoutingSchema
>;
...
export const guestDashboardAnalytics = pgTable("guest_dashboard_analytics", {
  ...
  guestSatisfactionScore: decimal("guest_satisfaction_score", {
    precision: 3,
    scale: 2,
  }),
  topRequestedServices: text("top_requested_services").array(),
  commonIssues: text("common_issues").array(),
  aiTaskCreationRate: decimal("ai_task_creation_rate", {
    precision: 5,
    scale: 2,
  }),
...
export const staffSalarySettings = pgTable("staff_salary_settings", {
  ...
  fixedMonthlySalary: decimal("fixed_monthly_salary", {
    precision: 10,
    scale: 2,
  }).notNull(),
  currency: varchar("currency").default("AUD"),
  hourlyOvertime: decimal("hourly_overtime", { precision: 10, scale: 2 }),
  emergencyTaskBonus: decimal("emergency_task_bonus", {
    precision: 10,
    scale: 2,
  }),
...
export const staffClockLog = pgTable("staff_clock_log", {
  ...
  overtimeApprovalStatus: varchar("overtime_approval_status").default(
    "pending",
...
export const propertyLocalContacts = pgTable("property_local_contacts", {
  ...
  requiresManagerConfirmation: boolean("requires_manager_confirmation").default(
    false,
  ),
  isActive: boolean("is_active").default(true),
  displayOrder: integer("display_order").default(0),
...
export const monthlyPayroll = pgTable("monthly_payroll", {
  ...
  overtimeHours: decimal("overtime_hours", { precision: 10, scale: 2 }).default(
    "0",
  ),
  overtimePay: decimal("overtime_pay", { precision: 10, scale: 2 }).default(
    "0",
  ),
  emergencyBonuses: decimal("emergency_bonuses", {
    precision: 10,
    scale: 2,
  }).default("0"),
  totalEarnings: decimal("total_earnings", {
...
export const payrollSummary = pgTable("payroll_summary", {
  ...
  totalFixedSalaries: decimal("total_fixed_salaries", {
    precision: 10,
    scale: 2,
  }).notNull(),
  totalOvertimePay: decimal("total_overtime_pay", {
    precision: 10,
    scale: 2,
  }).default("0"),
  totalEmergencyBonuses: decimal("total_emergency_bonuses", {
    precision: 10,
    scale: 2,
  }).default("0"),
  ...
  paymentCompletionRate: decimal("payment_completion_rate", {
    precision: 5,
    scale: 2,
  }),
  averageOvertimeHours: decimal("average_overtime_hours", {
    precision: 10,
    scale: 2,
  }),
  createdAt: timestamp("created_at").defaultNow(),
...
export const guestCommunicationNotifications = pgTable(
...
export const guestPortalSettings = pgTable("guest_portal_settings", {
  ...
  aiConfidenceThreshold: decimal("ai_confidence_threshold", {
    precision: 3,
    scale: 2,
  }).default("0.75"),
...
export const guestMessagesRelations = relations(
  guestMessages,
  ({ one, many }) => ({
    organization: one(organizations, {
...
export const aiGeneratedTasksRelations = relations(
  aiGeneratedTasks,
  ({ one }) => ({
    organization: one(organizations, {
...
export const aiSmartSuggestionsRelations = relations(
  aiSmartSuggestions,
  ({ one }) => ({
    organization: one(organizations, {
...
export const guestCommunicationNotificationsRelations = relations(
...
export const guestPortalSettingsRelations = relations(
  guestPortalSettings,
  ({ one }) => ({
    organization: one(organizations, {
...
export const propertyPayoutRules = pgTable(
...
export const bookingIncomeRecords = pgTable(
  "booking_income_records",
  {
    ...
    // OTA Dual Commission Tracking
    guestTotalPrice: decimal("guest_total_price", {
      precision: 10,
      scale: 2,
    }).notNull(), // What guest paid to OTA
    platformPayout: decimal("platform_payout", {
      precision: 10,
      scale: 2,
    }).notNull(), // What host receives after OTA commission
    otaCommissionAmount: decimal("ota_commission_amount", {
      precision: 10,
      scale: 2,
    }).default("0.00"), // OTA commission deducted

    // Legacy field for backward compatibility
    totalRentalIncome: decimal("total_rental_income", {
      precision: 10,
      scale: 2,
    }).notNull(), // Will map to platformPayout
    ...
    actualAmountReceived: decimal("actual_amount_received", {
      precision: 10,
      scale: 2,
    }),
...
export const ownerBalanceRequests = pgTable(
...
export const commissionPayouts = pgTable(
  "commission_payouts",
  {
    ...
    propertyId: integer("property_id").references(() => properties.id),
    period: varchar("period").notNull(), // YYYY-MM format
    baseCommissionAmount: decimal("base_commission_amount", {
      precision: 10,
      scale: 2,
    }).notNull(),
...
export const propertyTimelineEvents = pgTable(
...
export const platformAnalytics = pgTable(
  "platform_analytics",
  {
    ...
    totalAddonServices: decimal("total_addon_services", {
      precision: 10,
      scale: 2,
    }).default("0.00"),
    averageNightlyRate: decimal("average_nightly_rate", {
...
export const propertyPayoutRulesRelations = relations(
  propertyPayoutRules,
  ({ one }) => ({
    organization: one(organizations, {
...
export const bookingIncomeRecordsRelations = relations(
...
export const ownerBalanceRequestsRelations = relations(
...
export const propertyTimelineEventsRelations = relations(
...
export const platformAnalyticsRelations = relations(
  platformAnalytics,
  ({ one }) => ({
    organization: one(organizations, {
...
export type InsertBookingIncomeRecord =
  typeof bookingIncomeRecords.$inferInsert;

export type OwnerBalanceRequest = typeof ownerBalanceRequests.$inferSelect;
export type InsertOwnerBalanceRequest =
  typeof ownerBalanceRequests.$inferInsert;
...
export type InsertPropertyTimelineEvent =
  typeof propertyTimelineEvents.$inferInsert;
...
export const insertPropertyPayoutRuleSchema = createInsertSchema(
  propertyPayoutRules,
).omit({
  id: true,
  createdAt: true,
...
export const insertBookingIncomeRecordSchema = createInsertSchema(
  bookingIncomeRecords,
).omit({
  id: true,
  createdAt: true,
...
export const insertOwnerBalanceRequestSchema = createInsertSchema(
  ownerBalanceRequests,
).omit({
  id: true,
  createdAt: true,
...
export const insertCommissionPayoutSchema = createInsertSchema(
  commissionPayouts,
).omit({
  id: true,
  createdAt: true,
...
export const insertPropertyTimelineEventSchema = createInsertSchema(
  propertyTimelineEvents,
).omit({
  id: true,
  createdAt: true,
...
export const insertPlatformAnalyticsSchema = createInsertSchema(
  platformAnalytics,
).omit({
  id: true,
  createdAt: true,
...
export const staffOvertimeSessions = pgTable(
...
export const multiCurrencyFinances = pgTable(
...
export const quickbooksIntegration = pgTable(
...
export const propertyFinanceSettings = pgTable(
  "property_finance_settings",
  {
    ...
    // Report Settings
    includeInMonthlyReports: boolean("include_in_monthly_reports").default(
      true,
    ),
...
export const financeExportLogs = pgTable(
  "finance_export_logs",
  {
    id: serial("id").primaryKey(),
    organizationId: varchar("organization_id")
...
export const financeReportTemplates = pgTable(
...
export const occupancyRates = pgTable(
  "occupancy_rates",
  {
    id: serial("id").primaryKey(),
    organizationId: varchar("organization_id")
    ...
    revenuePerAvailableRoom: decimal("revenue_per_available_room", {
      precision: 8,
      scale: 2,
    }),
    ...
    // Booking Data
    totalBookings: integer("total_bookings").default(0),
    averageStayLength: decimal("average_stay_length", {
      precision: 4,
      scale: 1,
    }),
...
export type InsertCurrencyExchangeRate =
  typeof currencyExchangeRates.$inferInsert;

export type MultiCurrencyFinance = typeof multiCurrencyFinances.$inferSelect;
export type InsertMultiCurrencyFinance =
  typeof multiCurrencyFinances.$inferInsert;

export type QuickbooksIntegration = typeof quickbooksIntegration.$inferSelect;
export type InsertQuickbooksIntegration =
  typeof quickbooksIntegration.$inferInsert;

export type PropertyFinanceSettings =
  typeof propertyFinanceSettings.$inferSelect;
export type InsertPropertyFinanceSettings =
  typeof propertyFinanceSettings.$inferInsert;
...
export type InsertFinanceReportTemplate =
  typeof financeReportTemplates.$inferInsert;
...
// Zod schemas for validation
export const insertCurrencyExchangeRateSchema = createInsertSchema(
...
export const insertMultiCurrencyFinanceSchema = createInsertSchema(
...
export const insertQuickbooksIntegrationSchema = createInsertSchema(
...
export const insertPropertyFinanceSettingsSchema = createInsertSchema(
...
export const insertFinanceExportLogSchema = createInsertSchema(
  financeExportLogs,
).omit({
  id: true,
  createdAt: true,
...
export const insertFinanceReportTemplateSchema = createInsertSchema(
...
export const insertOccupancyRateSchema = createInsertSchema(
  occupancyRates,
).omit({
  id: true,
  createdAt: true,
...
export const insertCommunicationChannelSchema = createInsertSchema(
...
export const insertOwnerPmCommunicationSchema = createInsertSchema(
...
export const insertGuestSmartRequestSchema = createInsertSchema(
  guestSmartRequests,
).omit({
  id: true,
  createdAt: true,
...
export const insertSmartRequestConfigSchema = createInsertSchema(
  smartRequestConfig,
).omit({
  id: true,
  createdAt: true,
...
export type InsertCommunicationChannel = z.infer<
  typeof insertCommunicationChannelSchema
>;
...
export type InsertOwnerPmCommunication = z.infer<
  typeof insertOwnerPmCommunicationSchema
>;
export type GuestSmartRequest = typeof guestSmartRequests.$inferSelect;
export type InsertGuestSmartRequest = z.infer<
  typeof insertGuestSmartRequestSchema
>;
...
export type InsertSmartRequestConfig = z.infer<
  typeof insertSmartRequestConfigSchema
>;
...
export const adminOverridePermissions = pgTable(
...
export const balanceOverrideHistory = pgTable(
...
export const portfolioManagerAssignments = pgTable(
  "portfolio_assignments",
  {
    ...
    propertyId: integer("property_id")
      .references(() => properties.id),
    commissionRate: decimal("commission_rate", { precision: 5, scale: 2 }).default("50"),
    assignedAt: timestamp("assigned_at").defaultNow(),
    unassignedAt: timestamp("unassigned_at"),
    isActive: boolean("is_active").default(true),
  },
...
export const insertAdminOverridePermissionSchema = createInsertSchema(
...
export const insertImpersonationSessionSchema = createInsertSchema(
...
export const insertBalanceOverrideHistorySchema = createInsertSchema(
...
export const insertPortfolioManagerAssignmentSchema = createInsertSchema(
...
export type AdminOverridePermission =
  typeof adminOverridePermissions.$inferSelect;
export type InsertAdminOverridePermission = z.infer<
  typeof insertAdminOverridePermissionSchema
>;
export type ImpersonationSession = typeof impersonationSessions.$inferSelect;
export type InsertImpersonationSession = z.infer<
  typeof insertImpersonationSessionSchema
>;
export type BalanceOverrideHistory = typeof balanceOverrideHistory.$inferSelect;
export type InsertBalanceOverrideHistory = z.infer<
  typeof insertBalanceOverrideHistorySchema
>;
export type PortfolioManagerAssignment =
  typeof portfolioManagerAssignments.$inferSelect;
export type InsertPortfolioManagerAssignment = z.infer<
  typeof insertPortfolioManagerAssignmentSchema
>;

// ===== PROPERTY ACCESS MANAGEMENT =====

// Property Access Credentials - Store all access methods for each property
export const propertyAccessCredentials = pgTable(
  "property_access_credentials",
  {
    ...
    rotationRemindersEnabled: boolean("rotation_reminders_enabled").default(
      true,
    ),
...
export const propertyAccessPhotos = pgTable("property_access_photos", {
  ...
  credentialId: integer("credential_id")
    .references(() => propertyAccessCredentials.id)
    .notNull(),
...
export const insertPropertyAccessCredentialSchema = createInsertSchema(
...
export const insertPropertyAccessPhotoSchema = createInsertSchema(
...
export const insertAccessChangeLogSchema = createInsertSchema(
  accessChangeLog,
).omit({
  id: true,
  changedAt: true,
...
export const insertGuestAccessSessionSchema = createInsertSchema(
  guestAccessSessions,
).omit({
  id: true,
...
export const insertSmartLockSyncLogSchema = createInsertSchema(
  smartLockSyncLog,
).omit({
  id: true,
  syncStartedAt: true,
...
export const insertCodeRotationScheduleSchema = createInsertSchema(
...
export type PropertyAccessCredential =
  typeof propertyAccessCredentials.$inferSelect;
export type InsertPropertyAccessCredential = z.infer<
  typeof insertPropertyAccessCredentialSchema
>;
export type PropertyAccessPhoto = typeof propertyAccessPhotos.$inferSelect;
export type InsertPropertyAccessPhoto = z.infer<
  typeof insertPropertyAccessPhotoSchema
>;
...
export type InsertGuestAccessSession = z.infer<
  typeof insertGuestAccessSessionSchema
>;
export type SmartLockSyncLog = typeof smartLockSyncLog.$inferSelect;
export type InsertSmartLockSyncLog = z.infer<
  typeof insertSmartLockSyncLogSchema
>;
export type CodeRotationSchedule = typeof codeRotationSchedule.$inferSelect;
export type InsertCodeRotationSchedule = z.infer<
  typeof insertCodeRotationScheduleSchema
>;

// ===== DAILY OPERATIONS DASHBOARD =====

// Daily Operations Summary - Aggregated data for specific dates
export const dailyOperationsSummary = pgTable(
  "daily_operations_summary",
  {
    ...
    uncleanedCheckinProperties: integer("uncleaned_checkin_properties").default(
      0,
    ),
...
export const dailyStaffAssignments = pgTable(
  "daily_staff_assignments",
  {
    ...
    taskCompletionRate: decimal("task_completion_rate", {
      precision: 5,
      scale: 2,
    }), // percentage
...
export const dailyPropertyOperations = pgTable(
...
export const insertDailyStaffAssignmentsSchema = createInsertSchema(
...
export const insertDailyPropertyOperationsSchema = createInsertSchema(
...
export type InsertDailyStaffAssignments = z.infer<
  typeof insertDailyStaffAssignmentsSchema
>;
export type DailyPropertyOperations =
  typeof dailyPropertyOperations.$inferSelect;
export type InsertDailyPropertyOperations = z.infer<
  typeof insertDailyPropertyOperationsSchema
>;
...
export const maintenanceTaskSuggestions = pgTable(
...
export const propertyUtilities = pgTable("property_utilities", {
  ...
  averageBillAmount: decimal("average_bill_amount", {
    precision: 10,
    scale: 2,
  }),
  currency: varchar("currency").default("THB"),
...
export const utilityBillHistory = pgTable("utility_bill_history", {
  ...
  utilityId: integer("utility_id")
    .references(() => propertyUtilities.id)
    .notNull(),
...
export const propertyInfoSummary = pgTable("property_info_summary", {
  ...
  totalMonthlyUtilityCost: decimal("total_monthly_utility_cost", {
    precision: 10,
    scale: 2,
  }),
  ...
  totalMaintenanceCostThisYear: decimal("total_maintenance_cost_this_year", {
    precision: 10,
    scale: 2,
  }),
...
export const insertPropertyServiceHistorySchema = createInsertSchema(
...
export const insertMaintenanceTaskSuggestionSchema = createInsertSchema(
...
export const insertPropertyUtilitySchema = createInsertSchema(
  propertyUtilities,
).omit({
  id: true,
  createdAt: true,
...
export const insertUtilityBillHistorySchema = createInsertSchema(
  utilityBillHistory,
).omit({
  id: true,
  createdAt: true,
...
export const insertUtilityBillAlertSchema = createInsertSchema(
  utilityBillAlerts,
).omit({
  id: true,
  createdAt: true,
...
export const insertPropertyInfoSummarySchema = createInsertSchema(
  propertyInfoSummary,
).omit({
  id: true,
  lastUpdated: true,
...
export type InsertPropertyServiceHistory = z.infer<
  typeof insertPropertyServiceHistorySchema
>;

export type MaintenanceTaskSuggestion =
  typeof maintenanceTaskSuggestions.$inferSelect;
export type InsertMaintenanceTaskSuggestion = z.infer<
  typeof insertMaintenanceTaskSuggestionSchema
>;
...
export type InsertUtilityBillHistory = z.infer<
  typeof insertUtilityBillHistorySchema
>;

export type UtilityBillAlert = typeof utilityBillAlerts.$inferSelect;
export type InsertUtilityBillAlert = z.infer<
  typeof insertUtilityBillAlertSchema
>;

export type PropertyInfoSummary = typeof propertyInfoSummary.$inferSelect;
export type InsertPropertyInfoSummary = z.infer<
  typeof insertPropertyInfoSummarySchema
>;

// ===== AUTO-SCHEDULING RULES & RECURRING TASK GENERATOR =====

// Auto-scheduling rules for recurring tasks
export const taskSchedulingRules = pgTable(
...
export const recurringTasks = pgTable(
  "recurring_tasks",
  {
    ...
    ruleId: integer("rule_id")
      .references(() => taskSchedulingRules.id)
      .notNull(),
...
export const recurringTaskAnalytics = pgTable(
  "recurring_task_analytics",
  {
    ...
    // Timing Analytics
    avgCompletionTime: decimal("avg_completion_time", {
      precision: 10,
      scale: 2,
    }), // Minutes
    ...
    photoEvidenceRate: decimal("photo_evidence_rate", {
      precision: 5,
      scale: 2,
    }),
...
export const taskSchedulingAlerts = pgTable(
...
export const insertTaskSchedulingRuleSchema = createInsertSchema(
  taskSchedulingRules,
).omit({
  id: true,
  createdAt: true,
...
export const insertRecurringTaskSchema = createInsertSchema(
  recurringTasks,
).omit({
  id: true,
  createdAt: true,
...
export const insertTaskGenerationLogSchema = createInsertSchema(
  taskGenerationLogs,
).omit({
  id: true,
  createdAt: true,
...
export const insertRecurringTaskAnalyticsSchema = createInsertSchema(
...
export const insertTaskSchedulingAlertSchema = createInsertSchema(
...
export type InsertTaskSchedulingRule = z.infer<
  typeof insertTaskSchedulingRuleSchema
>;
...
export type InsertTaskGenerationLog = z.infer<
  typeof insertTaskGenerationLogSchema
>;

export type RecurringTaskAnalytics = typeof recurringTaskAnalytics.$inferSelect;
export type InsertRecurringTaskAnalytics = z.infer<
  typeof insertRecurringTaskAnalyticsSchema
>;

export type TaskSchedulingAlert = typeof taskSchedulingAlerts.$inferSelect;
export type InsertTaskSchedulingAlert = z.infer<
  typeof insertTaskSchedulingAlertSchema
>;
...
export const applianceRepairs = pgTable(
  "appliance_repairs",
  {
    id: serial("id").primaryKey(),
    applianceId: integer("appliance_id").references(
...
export const insertPropertyApplianceSchema = createInsertSchema(
  propertyAppliances,
).omit({
  id: true,
  createdAt: true,
...
export const insertApplianceRepairSchema = createInsertSchema(
  applianceRepairs,
).omit({
  id: true,
  createdAt: true,
...
export type InsertPropertyAppliance = z.infer<
  typeof insertPropertyApplianceSchema
>;
...
export const propertyStatus = pgTable(
  "property_status",
  {
    id: serial("id").primaryKey(),
    organizationId: varchar("organization_id").notNull(),
...
export const insertPropertyStatusSchema = createInsertSchema(
  propertyStatus,
).omit({
  id: true,
  lastUpdate: true,
...
export const insertPropertyReviewSchema = createInsertSchema(
  propertyReviews,
).omit({
  id: true,
  createdAt: true,
...
export const insertSecurityDepositSchema = createInsertSchema(
  securityDeposits,
).omit({
  id: true,
  createdAt: true,
...
export const insertWhatsappBotLogSchema = createInsertSchema(
  whatsappBotLogs,
).omit({
  id: true,
  createdAt: true,
...
export const seasonalForecasts = pgTable(
  "seasonal_forecasts",
  {
    id: serial("id").primaryKey(),
    organizationId: varchar("organization_id").notNull(),
    ...
    expectedOccupancy: decimal("expected_occupancy", {
      precision: 5,
      scale: 2,
    }),
...
export const insertSeasonalForecastSchema = createInsertSchema(
  seasonalForecasts,
).omit({
  id: true,
  createdAt: true,
...
export type InsertSeasonalForecast = z.infer<
  typeof insertSeasonalForecastSchema
>;
...
export type InsertSustainabilityMetric = z.infer<
  typeof insertSustainabilityMetricSchema
>;

// ===== PORTFOLIO HEALTH SCORING SYSTEM =====

export const portfolioHealthScores = pgTable(
...
export const insertPortfolioHealthScoreSchema = createInsertSchema(
...
export type InsertPortfolioHealthScore = z.infer<
  typeof insertPortfolioHealthScoreSchema
>;

// ===== GUEST ID VERIFICATION SYSTEM =====

export const guestIdScans = pgTable(
  "guest_id_scans",
  {
    id: serial("id").primaryKey(),
    bookingId: integer("booking_id").references(() => bookings.id),
...
export const maintenanceBudgetForecasts = pgTable(
...
export const insertMaintenanceBudgetForecastSchema = createInsertSchema(
...
export type MaintenanceBudgetForecast =
  typeof maintenanceBudgetForecasts.$inferSelect;
export type InsertMaintenanceBudgetForecast = z.infer<
  typeof insertMaintenanceBudgetForecastSchema
>;

// ===== STAFF WORKLOAD STATISTICS SYSTEM =====

export const staffWorkloadStats = pgTable(
  "staff_workload_stats",
  {
    ...
    hoursLogged: decimal("hours_logged", { precision: 5, scale: 2 }).default(
      "0",
    ),
    createdAt: timestamp("created_at").defaultNow(),
  },
...
export const insertStaffWorkloadStatsSchema = createInsertSchema(
  staffWorkloadStats,
).omit({
  id: true,
  createdAt: true,
...
export type InsertStaffWorkloadStats = z.infer<
  typeof insertStaffWorkloadStatsSchema
>;

// ===== PROPERTY INSURANCE SYSTEM =====

export const propertyInsurance = pgTable(
  "property_insurance",
  {
    id: serial("id").primaryKey(),
    propertyId: integer("property_id").references(() => properties.id),
...
export const insertPropertyInsuranceSchema = createInsertSchema(
  propertyInsurance,
).omit({
  id: true,
  createdAt: true,
...
export type InsertPropertyInsurance = z.infer<
  typeof insertPropertyInsuranceSchema
>;
...
export const insertAutomationLogSchema = createInsertSchema(
  automationLogs,
).omit({
  id: true,
  executedAt: true,
...
export const aiNotifications = pgTable(
  "ai_notifications",
  {
    ...
    organizationId: varchar("organization_id")
      ...
      .notNull(),
    propertyId: integer("property_id").references(() => properties.id),
    alertType: varchar("alert_type", { length: 100 }).notNull(), // pest, electricity, cleaning, ac, upgrade, etc.
    title: varchar("title", { length: 255 }).notNull(),
    description: text("description"),
    priority: varchar("priority", { length: 50 }).notNull(), // low, medium, high, critical
    status: varchar("status", { length: 50 }).notNull(), // active, snoozed, resolved, dismissed
    dueDate: timestamp("due_date"),
    snoozeUntil: timestamp("snooze_until"),
    lastServiceDate: timestamp("last_service_date"),
    estimatedNextDate: timestamp("estimated_next_date"),
    aiConfidence: varchar("ai_confidence", { length: 10 }), // 0.00-1.00
    sourceType: varchar("source_type", { length: 100 }), // service_log, bill_pattern, maintenance_history, manual, etc.
    sourceId: varchar("source_id", { length: 255 }),
    visibleToRoles: text("visible_to_roles").array(),
    assignedTo: varchar("assigned_to").references(() => users.id),
    createdBy: varchar("created_by").notNull(), // can be ai-system, goals-system, or user ID
    actionTaken: boolean("action_taken").default(false),
    actionTakenBy: varchar("action_taken_by").references(() => users.id),
    actionTakenAt: timestamp("action_taken_at"),
    actionNotes: text("action_notes"),
...
export const aiReminderSettings = pgTable(
  "ai_reminder_settings",
  {
    ...
    organizationId: varchar("organization_id")
      ...
      .notNull(),
    propertyId: integer("property_id").references(() => properties.id),
    alertType: varchar("alert_type", { length: 100 }).notNull(), // pest, electricity, cleaning, etc.
    enabled: boolean("enabled").default(true),
    intervalDays: integer("interval_days").notNull(), // How often the service/check should occur
    reminderDaysBefore: integer("reminder_days_before").default(3), // How many days before due date to remind
    autoCreateTasks: boolean("auto_create_tasks").default(false),
    notificationMethods: text("notification_methods").array(), // dashboard, email, sms, etc.
    customRules: jsonb("custom_rules").$type<{
      priority?: string;
      escalation?: string;
      bill_arrival_window?: string;
      amount_variance_alert?: string;
...
export const insertAiReminderSettingSchema = createInsertSchema(
  aiReminderSettings,
).omit({
  id: true,
  createdAt: true,
...
export type InsertAiReminderSetting = z.infer<
  typeof insertAiReminderSettingSchema
>;

export const aiNotificationHistory = pgTable(
  "ai_notification_history",
  {
    ...
    eventType: varchar("event_type", { length: 100 }).notNull(), // created, updated, snoozed, resolved, dismissed, etc.
    eventStatus: varchar("event_status", { length: 50 }),
    metadata: jsonb("metadata"),
    actorId: varchar("actor_id").references(() => users.id), // Who performed the action
    actorType: varchar("actor_type", { length: 50 }), // user, ai-system, automation, etc.
    createdAt: timestamp("created_at").defaultNow(),
  },
  (table) => [
...
export const insertAiNotificationHistorySchema = createInsertSchema(
...
export type InsertAiNotificationHistory = z.infer<
  typeof insertAiNotificationHistorySchema
>;

// ===== INVOICE GENERATOR MODULE =====

// Main invoices table for billing owners, agents, and service providers
export const billingInvoices = pgTable("billing_invoices", {
  id: serial("id").primaryKey(),
  organizationId: varchar("organization_id").references(() => organizations.id).notNull(),
  invoiceNumber: varchar("invoice_number").notNull().unique(), // e.g., INV-2025-001
  
  // Client information
  clientType: varchar("client_type").notNull(), // owner, agent, service_provider
  clientId: varchar("client_id"), // References users.id for owner/agent
  ...
  dueDate: date("due_date").notNull(),
  description: text("description"), // High-level invoice description
  
  // Status tracking
  status: varchar("status").notNull().default("draft"), // draft, sent, paid, overdue, void
...
// Invoice line items
export const billingInvoiceLineItems = pgTable("billing_invoice_line_items", {
  id: serial("id").primaryKey(),
  invoiceId: integer("invoice_id").references(() => billingInvoices.id, { onDelete: "cascade" }).notNull(),
  ...
  taxRate: decimal("tax_rate", { precision: 5, scale: 2 }).default("0"), // Percentage (e.g., 7.00 for 7%)
  discount: decimal("discount", { precision: 12, scale: 2 }).default("0"), // Flat amount
...
// Invoice templates for reusable invoice configurations
export const billingInvoiceTemplates = pgTable("billing_invoice_templates", {
  id: serial("id").primaryKey(),
  organizationId: varchar("organization_id").references(() => organizations.id).notNull(),
...
// Template line items (default line items for templates)
export const billingTemplateLineItems = pgTable("billing_template_line_items", {
  id: serial("id").primaryKey(),
  templateId: integer("template_id").references(() => billingInvoiceTemplates.id, { onDelete: "cascade" }).notNull(),
...
// Insert schemas for Invoice Generator
...
export const insertBillingInvoiceLineItemSchema = createInsertSchema(billingInvoiceLineItems).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertBillingInvoiceTemplateSchema = createInsertSchema(billingInvoiceTemplates).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});

export const insertBillingTemplateLineItemSchema = createInsertSchema(billingTemplateLineItems).omit({
  id: true,
  createdAt: true,
});
...
export type BillingInvoiceLineItem = typeof billingInvoiceLineItems.$inferSelect;
export type InsertBillingInvoiceLineItem = z.infer<typeof insertBillingInvoiceLineItemSchema>;

export type BillingInvoiceTemplate = typeof billingInvoiceTemplates.$inferSelect;
export type InsertBillingInvoiceTemplate = z.infer<typeof insertBillingInvoiceTemplateSchema>;

export type BillingTemplateLineItem = typeof billingTemplateLineItems.$inferSelect;
export type InsertBillingTemplateLineItem = z.infer<typeof insertBillingTemplateLineItemSchema>;
