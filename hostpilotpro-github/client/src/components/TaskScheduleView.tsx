...
// Mock task data with comprehensive examples
const mockTasks: Task[] = [
  {
    id: 1,
    title: "Morning Pool Cleaning",
    description: "Full pool cleaning including skimming, vacuuming, and chemical testing",
    department: 'pool',
    taskType: 'cleaning',
    property: "Villa Samui Breeze",
    propertyId: 1,
    assignedTo: "Moo (Pool Team)",
    assignedToId: "staff-moo",
    priority: 'routine',
    status: 'pending',
    ...
    createdBy: "Admin",
    attachments: ["pool-cleaning-guide.pdf"]
  },
  {
    id: 2,
    title: "Garden Maintenance",
    description: "Watering plants, pruning bushes, and lawn maintenance",
    department: 'garden',
    taskType: 'maintenance',
    property: "Villa Aruna",
    propertyId: 2,
    assignedTo: "Kla (Garden Team)",
    assignedToId: "staff-kla",
    priority: 'routine',
    status: 'confirmed',
    scheduledDate: new Date(),
    scheduledTime: "09:30",
    ...
    attachments: ["garden-tasks.jpg"]
  },
  {
    id: 3,
    title: "Guest Check-out Cleaning",
    description: "Full villa cleaning after guest departure",
    department: 'housekeeping',
    taskType: 'cleaning',
    property: "Villa Tropical Paradise",
    propertyId: 3,
    assignedTo: "Nok (Housekeeping)",
    assignedToId: "staff-nok",
    priority: 'urgent',
    status: 'completed',
    scheduledDate: new Date(),
    scheduledTime: "11:00",
    ...
    notes: "All rooms cleaned thoroughly. Guest left positive review note.",
    createdBy: "Admin"
  },
  {
    id: 4,
    title: "Pest Control Treatment",
    description: "Monthly pest control treatment for all areas",
    department: 'pest',
    taskType: 'treatment',
    property: "Villa Balinese Charm",
    propertyId: 4,
    assignedTo: "Som (Pest Control)",
    assignedToId: "staff-som",
    priority: 'recurring',
    status: 'in_progress',
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-4">
            ...
            <Select value={propertyFilter} onValueChange={setPropertyFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="Villa Tropical Paradise">Villa Tropical Paradise</SelectItem>
                <SelectItem value="Villa Balinese Charm">Villa Balinese Charm</SelectItem>
              </SelectContent>
            </Select>
