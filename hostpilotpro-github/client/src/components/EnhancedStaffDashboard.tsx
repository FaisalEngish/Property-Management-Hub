...
export default function EnhancedStaffDashboard({ 
  ...
  const recentCompletions = [
    { id: 1, task: "Villa Aruna Pool Cleaning", time: "09:30", rating: 5, photos: 3 },
    { id: 2, task: "Garden Maintenance - Villa Breeze", time: "11:15", rating: 4, photos: 2 },
    { id: 3, task: "Emergency AC Repair", time: "14:20", rating: 5, photos: 1 },
  ];
