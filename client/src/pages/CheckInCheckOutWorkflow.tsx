...
export default function CheckInCheckOutWorkflow() {
  ...
  const formatWithConversion = (amount: string | number, currency = 'THB') => {
                          ...
                          <div>
                            ...
                            <p className="font-medium">
                              {checkIn.depositType === 'none' ? 'No Deposit' : 
                               `${formatWithConversion(checkIn.depositAmount, checkIn.depositCurrency)}`}
                            </p>
                          </div>
                          <div>
                      ...
                      {checkOut.status === 'completed' && (
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-3 pt-3 border-t">
                          ...
                          <div>
                            ...
                            <p className="font-medium">
                              {formatWithConversion(checkOut.totalElectricityCharge)}
                              {checkOut.discountAmount > 0 && (
                                <span className="text-sm text-green-600 ml-1">
                                  (-{formatWithConversion(checkOut.discountAmount)})
                                </span>
                              )}
                            </p>
                          </div>
