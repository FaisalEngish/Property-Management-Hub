              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-600">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {formatWithConversion(booking.totalAmount, booking.currency)}
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-xl font-bold text-green-600">
                      {formatWithConversion(selectedBooking.totalAmount, selectedBooking.currency)}
                    </p>
                  </div>
                  <div>
                  ...
                  {selectedBooking.agentCommissionApplicable && (
                    <div>
                      ...
                      <p className="font-semibold text-blue-600">
                        {formatWithConversion(selectedBooking.agentCommissionAmount, selectedBooking.currency)}
                      </p>
                    </div>
                  )}
                </div>
