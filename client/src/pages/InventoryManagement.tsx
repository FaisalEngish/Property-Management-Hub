          ...
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{formatWithConversion(totalValue)}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{formatWithConversion(recentUsage)}</p>
              </div>
            </div>
          </CardContent>
        </Card>
                ...
                <Card key={item.id} className="border border-gray-200 dark:border-gray-700">
                  <CardContent className="p-4">
                    ...
                    <div className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
                      <p>Unit: {item.unit}</p>
                      <p>Price: {formatWithConversion(parseFloat(item.defaultPrice || "0"))}</p>
                    </div>
                  </CardContent>
                </Card>
              );
