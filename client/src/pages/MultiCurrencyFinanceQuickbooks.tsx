                        ...
                        <tr key={finance.id} className="border-b hover:bg-muted/25">
                          ...
                          <td className="p-4">
                            <div className="font-medium">
                              {formatCurrency(parseFloat(finance.originalAmount), finance.originalCurrency)}
                            </div>
                          ...
                          <td className="p-4 font-medium">
                            {formatCurrency(parseFloat(finance.thbAmount))}
                          </td>
                  ...
                  currencyBreakdown.map((item: any) => (
                    <div key={item.currency} className="flex justify-between items-center">
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-sm text-muted-foreground">
                          ≈ {formatCurrency(item.thbEquivalent, "THB")}
                        </div>
                      </div>
                    </div>
                  ))
