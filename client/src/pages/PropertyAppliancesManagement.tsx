        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{formatWithConversion(totalCost)}</div>
                ...
                {repairs.slice(0, 3).map((repair: any) => (
                  <div key={repair.id} className="flex items-center justify-between p-4 border rounded-lg">
                    ...
                    <div className="text-right">
                      <p className="font-medium">{formatWithConversion(repair.repairCost)}</p>
                    ...
                    {repairs.length === 0 ? (
                      ...
                      repairs.map((repair: any) => (
                        <TableRow key={repair.id}>
                          ...
                          <TableCell className="font-medium">
                            {repair.repairCost ? formatWithConversion(repair.repairCost) : "N/A"}
                          </TableCell>
                  ...
                  {properties.map((property: any) => {
                    ...
                    return (
                      <div key={property.id} className="flex items-center justify-between">
                        ...
                        <span className="text-sm font-medium">{formatWithConversion(totalCost)}</span>
                      </div>
                    );
                  })}
                </div>
