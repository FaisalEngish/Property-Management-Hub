...
export default function StaffExpenseManagement() {
  ...
  const pendingExpenses = (expensesData || []).filter((e: any) => e.status === "pending_review");
  const reviewedExpenses = (expensesData || []).filter((e: any) => e.status === "approved" || e.status === "rejected");
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-red-600">
                  {formatWithConversion(getTotalPending())}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">
                  {formatWithConversion(getTotalByCategory('company_expense'))}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">
                  {formatWithConversion(getTotalByCategory('billed_to_guest'))}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-orange-600">
                  {formatWithConversion(getTotalByCategory('billed_to_owner'))}
                </p>
              </div>
                    ...
                    <div key={expense.id} className="border rounded-lg p-4 bg-red-50">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          <p className="text-2xl font-bold text-red-600">
                            {formatWithConversion(expense.amount)}
                          </p>
                          <Button 
              ...
              <div className="bg-gray-50 border rounded-lg p-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-green-600">{formatWithConversion(selectedExpense.amount)}</p>
                  </div>
                  <div>
