    ...
    <div className="space-y-6 p-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {summaryLoading ? "..." : formatWithConversion(summary?.totalEarned || 0)}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {summaryLoading ? "..." : formatWithConversion(summary?.thisMonthEarnings || 0)}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {summaryLoading ? "..." : formatWithConversion(summary?.pendingCommissions || 0)}
            </div>
                    ...
                    {commissionsLoading ? (
                      ...
                      commissions.map((commission) => (
                        <TableRow key={commission.id}>
                          ...
                          <TableCell className="font-medium">
                            {formatWithConversion(commission.commissionAmount)}
                    ...
                    {invoicesLoading ? (
                      ...
                      invoices.map((invoice) => (
                        <TableRow key={invoice.id}>
                          ...
                          <TableCell className="font-medium">
                            {formatWithConversion(invoice.totalCommissions)}
                          </TableCell>
                          <TableCell>
