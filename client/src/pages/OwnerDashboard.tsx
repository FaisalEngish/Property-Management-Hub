                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-blue-800">
                      {formatWithConversion(earningsData?.averageNightlyRate || 0)}
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-green-800">
                      {formatWithConversion(earningsData?.totalEarnings?.[selectedPeriod] || 0)}
                    </p>
                  </div>
              ...
              <div key={platform} className={`p-4 rounded-lg border ${PLATFORM_COLORS[platform as keyof typeof PLATFORM_COLORS]}`}>
                <div className="text-center">
                  ...
                  {platform !== 'direct' && data.guestTotalPrice && data.otaCommissionAmount ? (
                    ...
                    <p className="text-sm">{formatWithConversion(data.revenue)}</p>
                  )}
              ...
              <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <div className="flex items-center gap-4">
                  <div className="text-right">
                    <div className="font-semibold">{formatWithConversion(month.revenue)}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 bg-green-50 rounded-lg border border-green-200 text-center">
              ...
              <p className="text-3xl font-bold text-green-800">
                {formatWithConversion(balanceData?.totalBalance || 0)}
              </p>
            </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <p className="text-2xl font-bold text-green-600">
                        {formatWithConversion(property.currentBalance)}
                      </p>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-4">
                    <div className="text-center p-3 bg-blue-50 rounded">
                      ...
                      <p className="font-semibold">{formatWithConversion(property.totalRevenue)}</p>
                    </div>
                    <div className="text-center p-3 bg-red-50 rounded">
                      <p className="text-red-600 text-sm">Management</p>
                      <p className="font-semibold">{formatWithConversion(property.expenses.management)}</p>
                    </div>
                    <div className="text-center p-3 bg-yellow-50 rounded">
                      <p className="text-yellow-600 text-sm">Utilities</p>
                      <p className="font-semibold">{formatWithConversion(property.expenses.utilities)}</p>
                    </div>
                    <div className="text-center p-3 bg-purple-50 rounded">
                      <p className="text-purple-600 text-sm">Maintenance</p>
                      <p className="font-semibold">{formatWithConversion(property.expenses.maintenance)}</p>
                    </div>
                    <div className="text-center p-3 bg-green-50 rounded">
                      <p className="text-green-600 text-sm">Add-ons</p>
                      <p className="font-semibold">{formatWithConversion(property.expenses.addons)}</p>
                    </div>
                  </div>
            ...
            <div className="space-y-3">
              {balanceData.pendingPayoutRequests.map((request: any) => (
                <div key={request.id} className="flex items-center justify-between p-4 bg-orange-50 border border-orange-200 rounded-lg">
                  ...
                  <div className="text-right">
                    <p className="font-semibold text-lg">{formatWithConversion(request.amount)}</p>
                    <Badge className={
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <br />
                          <span className="font-medium">{formatWithConversion(suggestion.estimatedCost)}</span>
                        </div>
                        <div>
                          ...
                          {activity.metadata?.amount && (
                            <div className="flex items-center gap-1 mt-2">
                              ...
                              <span className="text-sm font-medium text-green-600">
                                {formatWithConversion(activity.metadata.amount)}
                              </span>
                            </div>
                          )}
                        </div>
                ...
                <SelectContent>
                  {balanceData?.propertyBalances?.map((property: any) => (
                    <SelectItem key={property.propertyId} value={property.propertyId.toString()}>
                      {property.propertyName} - {formatWithConversion(property.currentBalance)}
                    </SelectItem>
                  ))}
                </SelectContent>
              </Select>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="p-4 bg-green-50 rounded-lg border">
                  ...
                  <p className="text-2xl font-bold text-green-800">
                    {formatWithConversion(selectedPropertyBalance.totalRevenue)}
                  </p>
                </div>
                ...
                <div className="p-4 bg-blue-50 rounded-lg border">
                  ...
                  <p className="text-2xl font-bold text-blue-800">
                    {formatWithConversion(selectedPropertyBalance.currentBalance)}
                  </p>
                </div>
                <div className="p-4 bg-purple-50 rounded-lg border">
                  <h4 className="text-purple-600 font-medium">Pending</h4>
                  <p className="text-2xl font-bold text-purple-800">
                    {formatWithConversion(selectedPropertyBalance.pendingPayouts)}
                  </p>
                </div>
              </div>
                  ...
                  {selectedPropertyBalance.breakdown?.map((transaction: any, index: number) => (
                    <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded">
                      ...
                      <div className={`font-semibold ${
                        ...
                        {transaction.amount > 0 ? '+' : ''}{formatWithConversion(transaction.amount)}
                      </div>
                    </div>
                  ))}
                </div>
