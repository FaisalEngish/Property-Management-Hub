                                ...
                                >
                                  {bookingAtCell ? (
                                    ...
                                    <div
                                      ...
                                      title={`${bookingAtCell.booking.guestName}\n${bookingAtCell.booking.checkIn} - ${bookingAtCell.booking.checkOut}\nStatus: ${bookingAtCell.booking.status}\nSource: ${bookingAtCell.booking.source || 'LOCAL'}${bookingAtCell.booking.bookingPlatform ? `\nPlatform: ${bookingAtCell.booking.bookingPlatform}` : ''}`}
                                    >
                                      <div className="font-medium truncate flex items-center gap-1">
                                        {bookingAtCell.booking.source === 'HOSTAWAY' && (
                                          <span className="text-[9px] bg-white/20 px-1 rounded">H</span>
                                        )}
                                        {bookingAtCell.booking.guestName}
                                      </div>
        ...
        <Card className="mt-4">
          <CardContent className="p-4">
            <div className="flex items-center gap-6 text-sm flex-wrap">
              ...
              <div className="flex items-center gap-2">
                <span className="text-[10px] bg-gray-500 text-white px-1.5 py-0.5 rounded font-medium">H</span>
                <span>Hostaway Booking</span>
              </div>
            </div>
          </CardContent>
        </Card>
