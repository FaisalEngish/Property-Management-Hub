      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {salaryAnalytics && salaryAnalytics[0]
                ? formatWithConversion(salaryAnalytics[0].totalStaffCost)
                : formatWithConversion(0)}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {salaryAnalytics && salaryAnalytics[0]
                ? formatWithConversion(salaryAnalytics[0].totalOvertimeCost)
                : formatWithConversion(0)}
            </div>
                  ...
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <div className="text-2xl font-bold">{formatWithConversion(profile.monthlySalary)}</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-muted-foreground">{formatWithConversion(profile.emergencyCalloutRate)}</div>
                        </div>
                      </div>
                      <div className="flex items-center space-x-2">
                ...
                <Card key={commission.id}>
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <div className="text-lg font-bold">{formatWithConversion(commission.amount)}</div>
                        <div className="flex items-center space-x-2">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <div className="text-lg font-bold">
                          {timeClock.totalPay ? formatWithConversion(timeClock.totalPay) : "Pending"}
                        </div>
                        <div className="flex items-center space-x-2">
                ...
                <Card key={invoice.id}>
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <div className="text-lg font-bold">{formatWithConversion(invoice.totalAmount)}</div>
                        <div className="flex items-center space-x-2">
                  ...
                  salaryAnalytics && salaryAnalytics[0] && (
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{formatWithConversion(salaryAnalytics[0].totalStaffCost)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm text-muted-foreground">Overtime Cost</span>
                        <span className="font-medium">{formatWithConversion(salaryAnalytics[0].totalOvertimeCost)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm text-muted-foreground">Bonus Cost</span>
                        <span className="font-medium">{formatWithConversion(salaryAnalytics[0].totalBonusCost)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm text-muted-foreground">Emergency Cost</span>
                        <span className="font-medium">{formatWithConversion(salaryAnalytics[0].totalEmergencyCost)}</span>
                      </div>
                    </div>
                  )
                )}
                  ...
                  salaryAnalytics && salaryAnalytics[0] && (
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{formatWithConversion(salaryAnalytics[0].averageSalary)}</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      {emergencySummary.map((summary: any) => (
                        <div key={summary.id} className="border-b pb-2 last:border-b-0">
                          ...
                          <div className="flex justify-between text-xs text-muted-foreground">
                            ...
                            <span>{formatWithConversion(summary.totalPay)}</span>
                          </div>
