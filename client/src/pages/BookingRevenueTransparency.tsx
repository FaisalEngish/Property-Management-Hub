...
export default function BookingRevenueTransparency() {
  ...
  // Helper functions
  const formatWithConversion = (amount: number, currency: string = "USD") => {
      ...
      {analytics && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{formatWithConversion(analytics.totalGuestPayments)}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-red-600">{formatWithConversion(analytics.totalOtaFees)}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-600">{formatWithConversion(analytics.totalActualPayouts)}</div>
                  ...
                  <div key={platform.platform} className="mb-4 p-3 border rounded-lg">
                    ...
                    <div className="space-y-1 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span>{formatWithConversion(platform.totalGuestPayments)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Actual Payouts:</span>
                        <span className="text-green-600 font-medium">{formatWithConversion(platform.totalPayouts)}</span>
                      </div>
                      <div className="flex justify-between">
                    ...
                    <div key={month.month} className="border-b pb-3">
                      ...
                      <div className="grid grid-cols-3 gap-2 text-sm">
                        <div>
                          ...
                          <div className="font-medium">{formatWithConversion(month.guestPayments)}</div>
                        </div>
                        <div>
                          <div className="text-muted-foreground">OTA Fees</div>
                          <div className="text-red-600">{formatWithConversion(month.otaFees)}</div>
                        </div>
                        <div>
                          <div className="text-muted-foreground">Net Payouts</div>
                          <div className="text-green-600 font-medium">{formatWithConversion(month.actualPayouts)}</div>
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                <CardContent className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-gray-50 rounded-lg">
                    <div className="text-center">
                      ...
                      <div className="text-lg font-semibold">{formatWithConversion(booking.guestBookingPrice, booking.currency)}</div>
                    </div>
                    <div className="text-center">
                      <div className="text-sm text-muted-foreground">OTA Platform Fee</div>
                      <div className="text-lg font-semibold text-red-600">
                        -{formatWithConversion(booking.otaPlatformFee, booking.currency)}
                      </div>
                    </div>
                    <div className="text-center">
                      <div className="text-sm text-muted-foreground">Actual Payout Received</div>
                      <div className="text-lg font-semibold text-green-600">
                        {formatWithConversion(booking.finalPayout, booking.currency)}
                      </div>
                    </div>
                  </div>
                  ...
                  {booking.bookingType === "ota" && (
                    <Alert className="mt-4 border-blue-200 bg-blue-50">
                      ...
                      <AlertDescription className="text-blue-800">
                        <strong>OTA Commission Notice:</strong> This booking was sold for {formatWithConversion(booking.guestBookingPrice, booking.currency)} 
                        but actual payout is {formatWithConversion(booking.finalPayout, booking.currency)}. 
                        The difference of {formatWithConversion(booking.otaPlatformFee, booking.currency)} is the {booking.otaName} platform commission.
                      </AlertDescription>
                    </Alert>
                  )}
                </CardContent>
              ...
              {analytics && (
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="text-center p-4 border rounded-lg">
                      <div className="text-2xl font-bold">
                        {formatWithConversion((analytics.totalOtaFees / analytics.totalBookings))}
                      </div>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="text-center p-4 border rounded-lg">
                      ...
                      <div className="text-2xl font-bold">
                        {formatWithConversion(selectedBooking.guestBookingPrice, selectedBooking.currency)}
                      </div>
                    ...
                    <div className="text-center p-4 border rounded-lg">
                      ...
                      <div className="text-2xl font-bold text-red-600">
                        -{formatWithConversion(selectedBooking.otaPlatformFee, selectedBooking.currency)}
                      </div>
                    ...
                    <div className="text-center p-4 border rounded-lg">
                      ...
                      <div className="text-2xl font-bold text-green-600">
                        {formatWithConversion(selectedBooking.finalPayout, selectedBooking.currency)}
                      </div>
                  ...
                  {selectedBooking.bookingType === "ota" && (
                    <Alert className="mt-4 border-orange-200 bg-orange-50">
                      ...
                      <AlertDescription className="text-orange-800">
                        ...
                        will be based on the final payout amount of {formatWithConversion(selectedBooking.finalPayout, selectedBooking.currency)} only. 
                        The {formatWithConversion(selectedBooking.otaPlatformFee, selectedBooking.currency)} {selectedBooking.otaName} commission 
