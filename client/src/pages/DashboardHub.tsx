      ...
      <div className="mb-8">
        <div className="relative max-w-md mx-auto">
          ...
          <Input
            ...
            className="pl-10 pr-4 py-3 rounded-xl border-2 border-slate-200/60 focus:border-emerald-300 focus:ring-2 focus:ring-emerald-100 transition-all duration-200 shadow-sm hover:shadow-md bg-white/80 backdrop-blur-sm"
          />
        </div>
      </div>
