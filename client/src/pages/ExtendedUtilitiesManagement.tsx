...
export default function ExtendedUtilitiesManagement() {
  ...
  const formatWithConversion = (amount: string, currency: string = "THB") => {
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600">{formatWithConversion(totalMonthlyBills.toString())}</p>
                </div>
                    ...
                    {utilityBills.slice(0, 5).map((bill) => (
                      <div key={bill.id} className="flex items-center justify-between p-3 border rounded-lg">
                        ...
                        <div className="text-right">
                          <p className="font-medium">{formatWithConversion(bill.billAmount, bill.currency)}</p>
                      ...
                      {billsLoading ? (
                        ...
                        filteredBills.map((bill) => (
                          <TableRow key={bill.id}>
                            ...
                            <TableCell>{formatWithConversion(bill.billAmount, bill.currency)}</TableCell>
                            <TableCell>
