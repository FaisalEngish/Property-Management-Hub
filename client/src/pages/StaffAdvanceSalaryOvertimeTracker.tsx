              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-green-600">{formatWithConversion(summaryStats.totalOvertimePay)}</p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-red-600">{formatWithConversion(summaryStats.totalAdvances)}</p>
                  </div>
                  ...
                  <div key={staff.id} className="border rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-6 gap-4 mb-3">
                      <div>
                        ...
                        <p className="font-medium">{formatWithConversion(staff.baseSalary)}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500">Overtime Rate</p>
                        <p className="font-medium">{formatWithConversion(staff.overtimeRate)}/hr</p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="font-medium text-green-600">{formatWithConversion(staff.overtimeEarnings)}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500">Current Advance</p>
                        <p className="font-medium text-red-600">{formatWithConversion(staff.currentAdvance)}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500">Net Earnings</p>
                        <p className="font-medium text-blue-600">
                          {formatWithConversion(staff.baseSalary + staff.overtimeEarnings - staff.currentAdvance)}
                        </p>
                      </div>
                    </div>
                ...
                {overtimeRecords.map((record) => (
                  <div key={record.id} className="flex items-center justify-between p-3 border rounded">
                    ...
                    <div className="text-right">
                      <p className="font-bold text-green-600">{formatWithConversion(record.amount)}</p>
                  ...
                  <div key={advance.id} className="border rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-3">
                      <div>
                        ...
                        <p className="font-medium">{formatWithConversion(advance.amount)}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500">Remaining Balance</p>
                        <p className="font-medium text-red-600">{formatWithConversion(advance.remainingBalance)}</p>
                      </div>
                      <div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="text-xs text-gray-500">
                        Monthly deduction: {formatWithConversion(advance.remainingBalance / parseInt(advance.repaymentPlan))}
                      </div>
                      <div className="flex gap-2">
                        <Button variant="outline" size="sm">View Details</Button>
                  ...
                  <div key={staff.id} className="border rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-red-600">-{formatWithConversion(staff.currentAdvance / 3)}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500">Net Pay</p>
                        <p className="font-bold text-blue-600">
                          {formatWithConversion(staff.baseSalary + staff.overtimeEarnings - (staff.currentAdvance / 3))}
                        </p>
                      </div>
                      <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div className="text-center">
                    ...
                    <p className="text-lg font-bold">
                      {formatWithConversion(staffMembers.reduce((sum, s) => sum + s.baseSalary, 0))}
                    </p>
                  </div>
                  <div className="text-center">
                    <p className="text-sm text-gray-600">Total Overtime Pay</p>
                    <p className="text-lg font-bold text-green-600">
                      {formatWithConversion(staffMembers.reduce((sum, s) => sum + s.overtimeEarnings, 0))}
                    </p>
                  </div>
                  <div className="text-center">
                    <p className="text-sm text-gray-600">Advance Deductions</p>
                    <p className="text-lg font-bold text-red-600">
                      -{formatWithConversion(staffMembers.reduce((sum, s) => sum + (s.currentAdvance / 3), 0))}
                    </p>
                  </div>
                  <div className="text-center">
                    <p className="text-sm text-gray-600">Total Net Payroll</p>
                    <p className="text-lg font-bold text-blue-600">
                      {formatWithConversion(staffMembers.reduce((sum, s) => sum + s.baseSalary + s.overtimeEarnings - (s.currentAdvance / 3), 0))}
                    </p>
                  </div>
                </div>
              </div>
