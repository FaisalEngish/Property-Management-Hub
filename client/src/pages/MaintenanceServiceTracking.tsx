                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      {formatWithConversion(dashboardSummary?.totalCost || 0)}
                    </div>
                    <p className="text-xs text-muted-foreground">
                      Avg: {formatWithConversion(dashboardSummary?.averageCostPerJob || 0)} per job
                    </p>
                  </CardContent>
                </Card>
              </div>
                        ...
                        <div key={recommendation.id} className="p-4 border rounded-lg">
                          ...
                          <div className="flex items-center justify-between mt-3">
                            <span className="text-sm font-medium">
                              {formatWithConversion(recommendation.estimatedCost || 0)}
                            </span>
                            <Button 
                              size="sm" 
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex items-center space-x-4 text-xs text-muted-foreground">
                                ...
                                {log.estimatedCost && (
                                  <>
                                    <span>•</span>
                                    <span>Est. {formatWithConversion(log.estimatedCost, log.currency)}</span>
                                  </>
                                )}
                              </div>
                            </div>
                        ...
                        <div className="flex items-start justify-between">
                          ...
                          <div className="text-right">
                            ...
                            {warranty.purchasePrice && (
                              <p className="text-sm text-muted-foreground mt-1">
                                {formatWithConversion(warranty.purchasePrice)}
                              </p>
                            )}
                          </div>
                        </div>
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center space-x-4 text-xs text-muted-foreground">
                              ...
                              {recommendation.estimatedCost && (
                                <>
                                  <span>•</span>
                                  <span>Est. {formatWithConversion(recommendation.estimatedCost)}</span>
                                </>
                              )}
                            </div>
                          </div>
              ...
              {selectedLog.estimatedCost && (
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm mt-1">{formatWithConversion(selectedLog.estimatedCost, selectedLog.currency)}</p>
                  </div>
                  {selectedLog.actualCost && (
                    <div>
                      <Label>Actual Cost</Label>
                      <p className="text-sm mt-1">{formatWithConversion(selectedLog.actualCost, selectedLog.currency)}</p>
                    </div>
                  )}
                </div>
              )}
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-4">
              ...
              {selectedRecommendation.estimatedCost && (
                <div>
                  <Label>Estimated Cost</Label>
                  <p className="text-sm mt-1">{formatWithConversion(selectedRecommendation.estimatedCost)}</p>
                </div>
              )}
