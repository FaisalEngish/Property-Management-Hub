...
export default function PropertyGoalsInvestmentPlans() {
  ...
  const getTriggerDisplay = (goal: PropertyGoal) => {
    switch (goal.triggerType) {
      case "revenue":
        return `Revenue: ${formatWithConversion(parseFloat(goal.revenueTarget || "0"), goal.currency)}`;
      case "occupancy":
                        ...
                        <div className="space-y-2 text-sm">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="font-medium">
                              {formatWithConversion(parseFloat(goal.estimatedCost), goal.currency)}
                            </span>
                          </div>
                          <div className="flex items-start justify-between">
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">
                        {formatWithConversion(analytics.summary.totalEstimatedCost, "THB")}
                      </div>
                      <p className="text-xs text-muted-foreground">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">
                        {formatWithConversion(analytics.summary.costVariance, "THB")}
                      </div>
                      <p className="text-xs text-muted-foreground">
                          ...
                          <div key={item.upgradeType} className="flex items-center justify-between">
                            ...
                            <div className="text-right">
                              <p className="font-medium">
                                {formatWithConversion(item.totalEstimatedCost, "THB")}
                              </p>
                              <p className="text-sm text-gray-600 dark:text-gray-400">
                                Est. cost
                              </p>
                    ...
                    <div>
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">
                            {formatWithConversion(parseFloat(selectedGoal.estimatedCost), selectedGoal.currency)}
                          </span>
                        </div>
                        {selectedGoal.actualCost && (
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">
                              {formatWithConversion(parseFloat(selectedGoal.actualCost), selectedGoal.currency)}
                            </span>
                          </div>
                        )}
                      </div>
