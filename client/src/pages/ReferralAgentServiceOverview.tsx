...
const ReferralAgentServiceOverview = () => {
  ...
  // Referred properties will be fetched from API - no hardcoded data
  const referredProperties: any[] = [];

  // Available properties will be fetched from API - no hardcoded data
                    ...
                    <Card key={property.id} className="border border-gray-200">
                      ...
                      <CardContent>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          <div className="text-center">
                            <div className="font-semibold text-green-600">{formatWithConversion(property.monthlyRevenue)}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-green-600">
                  {formatWithConversion(referredProperties.reduce((sum, prop) => sum + prop.commission, 0))}
                </div>
                    ...
                    <tbody>
                      {referredProperties.map((property) => (
                        <tr key={property.id} className="border-b">
                          ...
                          <td className="py-3">{formatWithConversion(property.monthlyRevenue)}</td>
                          <td className="py-3">{formatWithConversion(property.commission * 10)}</td>
                          <td className="py-3 font-semibold text-green-600">{formatWithConversion(property.commission)}</td>
                          <td className="py-3">
                            <Badge variant={property.status === "Active" ? "default" : "secondary"}>
                              {property.status}
                            </Badge>
