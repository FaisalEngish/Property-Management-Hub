              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600">
                    {formatWithConversion(analytics.totalRevenue)}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-red-600">
                    {formatWithConversion(analytics.totalExpenses)}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-600">
                    {formatWithConversion((analytics.totalRevenue || 0) - (analytics.totalExpenses || 0))}
                  </p>
                </div>
                ...
                <div key={finance.id} className="flex items-center justify-between p-4 border rounded-lg">
                  ...
                  <div className="text-right">
                    <p className={`font-semibold ${finance.type === 'revenue' ? 'text-green-600' : 'text-red-600'}`}>
                      {formatWithConversion(finance.amount)}
                    </p>
