                ...
                <div className="flex items-center">
                  <div className="flex-1">
                    ...
                    <p className="text-2xl font-bold text-gray-900">
                      {formatWithConversion(analytics.totalMonthlyBilling)}
                    </p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">{formatWithConversion(analytics.upcomingBills.totalAmount)}</p>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">{formatWithConversion(analytics.overdueBills.totalAmount)}</p>
                  </div>
                        ...
                        <div key={service.id} className="border rounded-lg p-4">
                          <div className="flex justify-between items-start">
                            ...
                            <div className="text-right">
                              <p className="font-semibold">{formatWithConversion(service.billingAmount)}</p>
                      ...
                      {bills.map((bill: any) => (
                        <div key={bill.id} className="border rounded-lg p-4">
                          <div className="flex justify-between items-start">
                            ...
                            <div className="text-right">
                              <p className="font-semibold text-lg">{formatWithConversion(bill.billAmount)}</p>
                              {bill.status === 'pending' && (
                                <Button 
                                  size="sm" 
                    ...
                    <div className="space-y-3">
                      {upcomingBills.map((bill: any) => (
                        <div key={bill.id} className="flex justify-between items-center p-3 bg-yellow-50 rounded-lg">
                          ...
                          <p className="font-semibold">{formatWithConversion(bill.billAmount)}</p>
                        </div>
                      ))}
                    </div>
                  )}
                    ...
                    <div className="space-y-3">
                      {overdueBills.map((bill: any) => (
                        <div key={bill.id} className="flex justify-between items-center p-3 bg-red-50 rounded-lg">
                          ...
                          <div className="text-right">
                            <p className="font-semibold text-red-600">{formatWithConversion(bill.billAmount)}</p>
                            <Button 
                              size="sm" 
                              variant="destructive"
                              onClick={() => handleMarkPaid(bill.id)}
                    ...
                    <div className="space-y-3">
                      {analytics.servicesByCategory.map((category: any) => (
                        <div key={category.category} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                          ...
                          <p className="font-semibold">{formatWithConversion(category.totalBilling)}/month</p>
                        </div>
                      ))}
                    </div>
                  </div>
