  ...
  return (
    <header className="sticky top-0 z-50 border-b border-gray-200 dark:border-gray-800 bg-white/95 dark:bg-gray-900/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:supports-[backdrop-filter]:bg-gray-900/60 shadow-sm">
      <div className="flex h-12 sm:h-14 items-center gap-2 sm:gap-4 px-3 sm:px-4 lg:px-6">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="min-w-0">
              <h1 className="text-sm sm:text-lg font-semibold text-gray-900 dark:text-white truncate lg:text-xl">
                {title}
              </h1>
              {subtitle && (
        ...
        {/* Action buttons - hidden on very small screens, shown in dropdown on mobile */}
        <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">{action}</div>
        ...
        <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="flex items-center gap-1 sm:gap-3 px-1 sm:pl-2 hover:bg-gray-100 dark:hover:bg-gray-800 min-w-0"
              >
                ...
                <div className="relative flex-shrink-0">
                  ...
                  <div
                    className={`absolute -bottom-0.5 -right-0.5 sm:-bottom-1 sm:-right-1 w-2.5 h-2.5 sm:w-3 sm:h-3 ${roleColor} rounded-full flex items-center justify-center border-2 border-white dark:border-gray-900`}
                  >
                    <RoleIcon className="w-1 h-1 sm:w-1.5 sm:h-1.5 text-white" />
                  </div>
                </div>
              </Button>
            </DropdownMenuTrigger>
