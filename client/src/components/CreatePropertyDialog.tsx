...
export default function CreatePropertyDialog({
  ...
  const createMutation = useMutation({
    ...
    onSuccess: async (data) => {
      console.log(
        "🎉 Frontend: Property creation successful, invalidating cache",
      );
    ...
    try {
      ...
      if (importedData.success) {
        ...
        toast({
          ...
          description:
            "Property data imported from Airbnb. Please review and save.",
        });

        setAirbnbUrl("");
      } else {
        throw new Error(
          importedData.message || "Failed to import property data",
        );
      }
    } catch (error: any) {
      ...
      toast({
        ...
        description:
          error.message ||
          "Could not import from Airbnb. Please enter property details manually.",
        variant: "destructive",
      });
    } finally {
          ...
          <TabsContent value="airbnb" className="space-y-4 mt-4">
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <p className="text-sm text-blue-700 mb-4">
                Enter an Airbnb listing URL to automatically import property
                details, photos, and amenities.
              </p>
