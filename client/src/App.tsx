...
import BookingsCentral from "./pages/BookingsCentral";
...
// Demo integration page disabled for production
...
function AppRoutes() {
  ...
  return (
    <div className="min-h-screen min-h-dvh bg-background w-full max-w-full overflow-x-hidden">
      <Sidebar />
      {/* Main content area with left margin for fixed sidebar - no margin on mobile since sidebar is overlay */}
      ...
      <Switch>
        ...
        <Route path="/ultra-fast-tasks" component={UltraFastTasks} />
        <Route path="/bookings" component={Bookings} />
        <Route path="/bookings-central" component={BookingsCentral} />
        ...
        {/* Integrations */}
        <Route path="/integrations/hostaway" component={HostawayIntegration} />
        ...
        {/* Demo integration disabled for production */}
